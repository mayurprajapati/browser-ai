import { R as e, I as r } from "./index-CiXNXYRN.js";
import { j as t, R as s } from "./index-BVS4T5_D.js";
import { P as i } from "./PairingPrompt-DmH8zDaR.js";
function n() {
    ...
    return t.jsx("div", {
        ...
        children: t.jsx("div", {
            ...
            children: t.jsx(i, {
                ...
                currentName: m,
                onConfirm: (e, r) => {
                    chrome.runtime.sendMessage({ type: "pairing_confirmed", request_id: e, name: r }),
                        setTimeout(n, 100);
                },
                onDismiss: (e) => {
                    chrome.runtime.sendMessage({ type: "pairing_dismissed", request_id: e }), setTimeout(n, 100);
                },
            }),
        }),
    });
