import { c as t, g as e } from "./index-BVS4T5_D.js";
import { h as n, H as r, P as i, g as s, S as o, s as a } from "./permissions-Cxwscq6K.js";
...
function v(t, ...e) {
    c &&
        _() &&
        g(() => {
            u.console[t](`Sentry Logger [${t}]:`, ...e);
        });
}
function b() {
    return c ? p("loggerSettings", () => ({ enabled: !1 })) : { enabled: !1 };
}
const y = {
        enable: function () {
            b().enabled = !0;
...
function E(...t) {
    ...
    return (t, n = 0, r = 0) => {
        ...
        return (function (t) {
            ...
            /sentryWrapped/.test(T(e).function || "") && e.pop();
            e.reverse(), x.test(T(e).function || "") && (e.pop(), x.test(T(e).function || "") && e.pop());
            return e
                .slice(0, 50)
                .map((t) => ({ ...t, filename: t.filename || T(e).filename, function: t.function || w }));
        })(i.slice(r));
    };
}
function T(t) {
...
function M(t, e) {
    if (!k[t]) {
        ...
        try {
            ...
            c && y.error(`Error while instrumenting ${t}`, n);
        }
    }
}
function R(t, e) {
    ...
    if (n)
        for (const i of n)
            try {
                ...
                c && y.error(`Error while triggering instrumentation handler.\nType: ${t}\nName: ${C(i)}\nError:`, r);
            }
}
let N = null;
function I() {
    (N = u.onerror),
        (u.onerror = function (t, e, n, r, i) {
            return R("error", { column: r, error: i, line: n, msg: t, url: e }), !!N && N.apply(this, arguments);
        }),
        (u.onerror.__SENTRY_INSTRUMENTED__ = !0);
}
let D = null;
function U() {
    (D = u.onunhandledrejection),
        (u.onunhandledrejection = function (t) {
            return R("unhandledrejection", t), !D || D.apply(this, arguments);
        }),
...
function B(t, e) {
    return $.call(t) === `[object ${e}]`;
}
function F(t) {
    return B(t, "ErrorEvent");
}
function G(t) {
    return B(t, "DOMError");
}
...
function H(t) {
    return null === t || V(t) || ("object" != typeof t && "function" != typeof t);
}
function W(t) {
    return B(t, "Object");
}
...
function Q(t, e = {}) {
    ...
    try {
        ...
        for (; n && s++ < r && ((u = Z(n, l)), !("html" === u || (s > 1 && o + i.length * c + u.length >= d))); )
...
function nt(t, e) {
    ...
    for (let r = 0; r < t.length; r++) {
        const e = t[r];
        try {
            Y(e) ? n.push("[VueViewModel]") : n.push(String(e));
        } catch {
...
function rt(t, e, n = !1) {
    return !!z(t) && (B(e, "RegExp") ? e.test(t) : !!z(e) && (n ? t === e : t.includes(e)));
}
function it(t, e = [], n = !1) {
...
function st(t, e, n) {
    ...
    const i = n(r);
    "function" == typeof i && at(i, r);
    try {
        t[e] = i;
    } catch {
        c && y.log(`Failed to replace method "${e}" in object`, t);
    }
}
function ot(t, e, n) {
    try {
        ...
        c && y.log(`Failed to add non-enumerable property "${e}" to object`, t);
    }
}
function at(t, e) {
    try {
        const n = e.prototype || {};
        (t.prototype = e.prototype = n), ot(t, "__sentry_original__", e);
    } catch {}
}
function ct(t) {
...
function ut(t) {
    if (j(t)) return { message: t.message, name: t.name, stack: t.stack, ...dt(t) };
    if (q(t)) {
        const e = { type: t.type, target: lt(t.target), currentTarget: lt(t.currentTarget), ...dt(t) };
        return "undefined" != typeof CustomEvent && X(t, CustomEvent) && (e.detail = t.detail), e;
    }
    return t;
}
function lt(t) {
    try {
        return (e = t), "undefined" != typeof Element && X(e, Element) ? Q(t) : Object.prototype.toString.call(t);
    } catch {
        return "<unknown>";
    }
    var e;
...
function pt(
    ...
    return (
        ht || (ht = "10000000100040008000100000000000"),
        ht.replace(/[018]/g, (t) => (t ^ (((16 * Math.random()) & 15) >> (t / 4))).toString(16))
    );
}
function mt(t) {
...
function wt() {
    return (
        ...
        (yt = (function () {
            ...
            if (!t?.now || !t.timeOrigin) return bt;
...
function Et(t, e, n = 2) {
    ...
    const r = { ...t };
    for (const i in e) Object.prototype.hasOwnProperty.call(e, i) && (r[i] = Et(r[i], e[i], n - 1));
    return r;
}
function Tt() {
    return pt();
...
function At() {
    return pt().substring(16);
}
const Ct = "_sentrySpan";
function Pt(t, e) {
    e ? ot(t, Ct, e) : delete t[Ct];
}
function Ot(t) {
    return t[Ct];
}
class kt {
    constructor() {
        (this._notifyingListeners = !1),
            ...
            (this._propagationContext = { traceId: Tt(), sampleRand: Math.random() });
    }
    clone() {
        const t = new kt();
        return (
    ...
    update(t) {
        ...
        const e = "function" == typeof t ? t(this) : t,
            n = e instanceof kt ? e.getScopeData() : W(e) ? t : void 0,
            { tags: r, extra: i, user: s, contexts: o, level: a, fingerprint: c = [], propagationContext: u } = n || {};
        return (
    ...
    clear() {
        return (
            ...
            Pt(this, void 0),
            (this._attachments = []),
            this.setPropagationContext({ traceId: Tt(), sampleRand: Math.random() }),
            this._notifyScopeListeners(),
            this
        );
    }
    addBreadcrumb(t, e) {
        ...
        if (n <= 0) return this;
        const r = { timestamp: bt(), ...t, message: t.message ? et(t.message, 2048) : t.message };
        return (
    ...
    setSDKProcessingMetadata(t) {
        return (this._sdkProcessingMetadata = Et(this._sdkProcessingMetadata, t, 2)), this;
    }
    ...
    captureException(t, e) {
        const n = e?.event_id || pt();
        if (!this._client) return c && y.warn("No client configured on scope - will not capture exception!"), n;
        const r = new Error("Sentry syntheticException");
        return (
            this._client.captureException(t, { originalException: t, syntheticException: r, ...e, event_id: n }, this),
            n
        );
    }
    captureMessage(t, e, n) {
        const r = n?.event_id || pt();
        if (!this._client) return c && y.warn("No client configured on scope - will not capture message!"), r;
        const i = new Error(t);
        return (
            this._client.captureMessage(t, e, { originalException: t, syntheticException: i, ...n, event_id: r }, this),
            r
        );
    }
    captureEvent(t, e) {
        ...
        return this._client
            ...
            : (c && y.warn("No client configured on scope - will not capture event!"), n);
    }
...
class Lt {
    constructor(t, e) {
        let n, r;
        (n = t || new kt()), (r = e || new kt()), (this._stack = [{ scope: n }]), (this._isolationScope = r);
    }
    withScope(t) {
...
function Mt() {
    ...
    return (t.stack =
        t.stack ||
        new Lt(
            p("defaultCurrentScope", () => new kt()),
            p("defaultIsolationScope", () => new kt())
        ));
}
function Rt(t) {
...
function Dt(t) {
    ...
    return e.acs
        ? e.acs
        : {
              withIsolationScope: It,
              withScope: Rt,
              withSetScope: Nt,
              withSetIsolationScope: (t, e) => It(e),
              getCurrentScope: () => Mt().getScope(),
              getIsolationScope: () => Mt().getIsolationScope(),
          };
}
function Ut() {
    return Dt(d()).getCurrentScope();
}
function $t() {
    return Dt(d()).getIsolationScope();
}
function jt() {
    return Ut().getClient();
}
function Bt(t) {
    const e = t.getPropagationContext(),
        ...
        s = { trace_id: n, span_id: i || At() };
    return r && (s.parent_span_id = r), s;
}
const Ft = "sentry.profile_id",
    Gt = "sentry.exclusive_time";
function zt(t) {
    if (t) {
...
function Vt(t) {
    const e = t;
    return { scope: e._sentryScope, isolationScope: zt(e._sentryIsolationScope) };
}
const Ht = /^sentry-/;
function Wt(t) {
    const e = (function (t) {
        if (!t || (!z(t) && !Array.isArray(t))) return;
        if (Array.isArray(t))
            return t.reduce((t, e) => {
                const n = qt(e);
                return (
    ...
    const e =
        "string" == typeof t
            ? (function (t) {
                  ...
                  return Jt({ host: s, pass: i, path: c, projectId: u, port: o, protocol: n, publicKey: r });
              })(t)
            : Jt(t);
    if (
        e &&
        (function (t) {
            ...
            return !(
                ["protocol", "publicKey", "host", "projectId"].find(
                    (e) => !t[e] && (y.error(`Invalid Sentry Dsn: ${e} missing`), !0)
                ) ||
                (n.match(/^\d+$/)
                    ? (function (t) {
                          return "http" === t || "https" === t;
                      })(r)
                        ? e && isNaN(parseInt(e, 10)) && (y.error(`Invalid Sentry Dsn: Invalid port ${e}`), 1)
...
function ee(t) {
    const { spanId: e, traceId: n, isRemote: r } = t.spanContext(),
        i = r ? e : se(t).parent_span_id,
        s = Vt(t).scope;
    return { parent_span_id: i, span_id: r ? s?.getPropagationContext().propagationSpanId || At() : e, trace_id: n };
}
function ne(t) {
    return t && t.length > 0
...
function se(t) {
    ...
    if (
        ...
        return {
            ...
            description: s,
            parent_span_id:
                "parentSpanId" in t ? t.parentSpanId : "parentSpanContext" in t ? t.parentSpanContext?.spanId : void 0,
            start_timestamp: re(i),
            timestamp: re(o) || void 0,
            status: oe(a),
            op: r["sentry.op"],
...
function le(t, e) {
    ...
    for (const n of e) {
        if (he(n)) {
            if (rt(t.description, n)) return c && ue(t), !0;
            continue;
        }
        if (!n.name && !n.op) continue;
        const e = !n.name || rt(t.description, n.name),
            r = !n.op || (t.op && rt(t.op, n.op));
        if (e && r) return c && ue(t), !0;
    }
    return !1;
}
function de(t, e) {
...
function me(t, e) {
    const n = e.getOptions(),
        ...
        i = { environment: n.environment || pe, release: n.release, public_key: r, trace_id: t, org_id: Qt(e) };
...
function fe(t) {
    ...
    const n = ae(t),
        ...
        o = s?.get("sentry.sample_rate") ?? i["sentry.sample_rate"] ?? i["sentry.previous_trace_sample_rate"];
    function a(t) {
    ...
    const u = s?.get("sentry.dsc"),
        l = u && Wt(u);
    if (l) return a(l);
    const d = me(t.spanContext().traceId, e),
        h = i["sentry.source"],
        p = r.description;
    return (
        ...
        (function () {
            ...
            (d.sample_rand =
                s?.get("sentry.sample_rand") ?? Vt(n).scope?.getPropagationContext().sampleRand.toString())),
        a(d),
        e.emit("createDsc", d, n),
        d
    );
}
function ge(t, e = 100, n = 1 / 0) {
    try {
        return ve("", t, e, n);
    } catch (r) {
...
function ve(
    ...
    const a = (function (t, e) {
        try {
            ...
            if (Y(e)) return "[VueViewModel]";
            if (W((n = e)) && "nativeEvent" in n && "preventDefault" in n && "stopPropagation" in n)
                return "[SyntheticEvent]";
            if ("number" == typeof e && !Number.isFinite(e)) return `[${e}]`;
            if ("function" == typeof e) return `[Function: ${C(e)}]`;
    ...
    const c =
        "number" == typeof e.__sentry_override_normalization_depth__ ? e.__sentry_override_normalization_depth__ : n;
    if (0 === c) return a.replace("object ", "");
    if (s(e)) return "[Circular ~]";
    const u = e;
    if (u && "function" == typeof u.toJSON)
        try {
            return ve("", u.toJSON(), c - 1, r, i);
        } catch {}
...
function xe(t) {
    ...
    function i(t) {
        "string" == typeof r
            ? (r = "string" == typeof t ? r + t : [Se(r), t])
            : r.push("string" == typeof t ? Se(t) : t);
    }
    for (const s of n) {
        const [t, e] = s;
...
function Ee(t) {
    const e = "string" == typeof t.data ? Se(t.data) : t.data;
    return [
        {
            type: "attachment",
            length: e.length,
...
class Le {
    ...
    _runExecutor(t) {
        const e = (t, e) => {
                0 === this._state &&
                    (K(e) ? e.then(n, r) : ((this._state = t), (this._value = e), this._executeHandlers()));
            },
            n = (t) => {
                e(1, t);
            },
...
function Re(t, e, n, r) {
    ...
    const s = i({ ...t }, e);
    return (
        c && null === s && y.log(`Event processor "${i.id || "?"}" dropped event`),
        K(s) ? s.then((t) => Re(t, e, n, r + 1)) : Re(s, e, n, r + 1)
    );
}
function Ne(t, e) {
    ...
    !(function (t, e) {
        ...
        r &&
            (function (t, e) {
                (t.contexts = { trace: ee(e), ...t.contexts }),
...
function Ie(t, e) {
    ...
    De(t, "extra", n),
        ...
        De(t, "user", i),
        De(t, "contexts", s),
        (t.sdkProcessingMetadata = Et(t.sdkProcessingMetadata, a, 2)),
        o && (t.level = o),
...
function Fe(t, e, n, r, i, s) {
    const { normalizeDepth: o = 3, normalizeMaxBreadth: a = 1e3 } = t,
        c = { ...e, event_id: e.event_id || n.event_id || pt(), timestamp: e.timestamp || bt() },
        l = n.integrations || t.integrations.map((t) => t.name);
    !(function (t, e) {
        const { environment: n, release: r, dist: i, maxValueLength: s = 250 } = e;
        (t.environment = t.environment || n || pe), !t.release && r && (t.release = r);
        !t.dist && i && (t.dist = i);
        const o = t.request;
        o?.url && (o.url = et(o.url, s));
    })(c, t),
        (function (t, e) {
            ...
            (function (t, e) {
                const n = (function (t) {
                    ...
                    const r = e ? Object.keys(e) : [],
                        i = n ? Object.keys(n) : [];
                    if (Be && r.length === $e && i.length === je) return Be;
                    ($e = r.length), (je = i.length), (Be = {}), Ue || (Ue = {});
                    const s = (e, n) => {
                        for (const r of e) {
                            const e = n[r],
                                i = Ue?.[r];
                            if (i && Be && e) (Be[i[0]] = e), Ue && (Ue[r] = [i[0], e]);
                            else if (e) {
                                const n = t(r);
    ...
    const d = (function (t, e) {
        if (!e) return t;
        const n = t ? t.clone() : new kt();
        return n.update(e), n;
    })(r, n.captureContext);
    n.mechanism && _t(c, n.mechanism);
    const h = i ? i.getEventProcessors() : [],
        m = p("globalScope", () => new kt()).getScopeData();
    if (s) {
        Ie(m, s.getScopeData());
    }
    if (d) {
    ...
    f.length && (n.attachments = f), Ne(c, m);
    return Me([...h, ...m.eventProcessors], c, n).then(
        (t) => (
            t &&
                (function (t) {
                    const e = {};
                      ...
                      const r = {
                          ...
                          ...(t.breadcrumbs && {
                              breadcrumbs: t.breadcrumbs.map((t) => ({
                                  ...t,
                                  ...(t.data && { data: ge(t.data, e, n) }),
                              })),
                          }),
                          ...(t.user && { user: ge(t.user, e, n) }),
                          ...(t.contexts && { contexts: ge(t.contexts, e, n) }),
                          ...(t.extra && { extra: ge(t.extra, e, n) }),
                      };
                      t.contexts?.trace &&
                          r.contexts &&
                          ((r.contexts.trace = t.contexts.trace),
                          t.contexts.trace.data && (r.contexts.trace.data = ge(t.contexts.trace.data, e, n)));
                      t.spans && (r.spans = t.spans.map((t) => ({ ...t, ...(t.data && { data: ge(t.data, e, n) }) })));
                      t.contexts?.flags && r.contexts && (r.contexts.flags = ge(t.contexts.flags, 3, n));
                      return r;
                  })(t, o, a)
                : t
        )
...
function ze(t) {
    const e = $t(),
        ...
        i = St({ user: n.getUser() || e.getUser(), ...(r && { userAgent: r }), ...t }),
        s = e.getSession();
    return "ok" === s?.status && xt(s, { status: "exited" }), Ve(), e.setSession(i), i;
}
function Ve() {
    const t = $t(),
        e = Ut().getSession() || t.getSession();
    e &&
        (function (t) {
            let e = {};
            "ok" === t.status && (e = { status: "exited" }), xt(t, e);
        })(e),
        He(),
        t.setSession();
}
...
function Je(t, e, n) {
    if (n[e.name]) c && y.log(`Integration skipped because it was already installed: ${e.name}`);
    else {
        if (
            ((n[e.name] = e),
            -1 === Ke.indexOf(e.name) && "function" == typeof e.setupOnce && (e.setupOnce(), Ke.push(e.name)),
        ...
        c && y.log(`Integration installed: ${e.name}`);
    }
}
function Qe(t, e) {
    const n =
        ...
        i = (function (t, e, n, r) {
            ...
            return (
                ...
                be(i, [
                    ((s = t),
                    [
                        { type: "log", item_count: s.length, content_type: "application/vnd.sentry.items.log+json" },
                        { items: s },
                    ]),
                ])
            );
    ...
    Ze().set(t, []), t.emit("flushLogs"), t.sendEnvelope(i);
}
function Ze() {
    return p("clientToLogBufferMap", () => new WeakMap());
}
function tn(t, e) {
    const n =
        e ??
    ...
    en().set(t, []), t.emit("flushMetrics"), t.sendEnvelope(i);
}
function en() {
    return p("clientToMetricBufferMap", () => new WeakMap());
}
function nn(t) {
    const e = [];
...
class pn {
    constructor(t) {
        if (
            ...
            (this._hooks = {}),
            (this._eventProcessors = []),
            t.dsn ? (this._dsn = Zt(t.dsn)) : c && y.warn("No DSN provided, client will not send events."),
            this._dsn)
        ) {
            const e = qe(this._dsn, t.tunnel, t._metadata ? t._metadata.sdk : void 0);
        ...
        this._options.enableLogs && hn(this, "afterCaptureLog", "flushLogs", _n, Qe),
            this._options._experiments?.enableMetrics && hn(this, "afterCaptureMetric", "flushMetrics", gn, tn);
    }
    captureException(t, e, n) {
        const r = pt();
        if (vt(t)) return c && y.log(rn), r;
        const i = { event_id: r, ...e };
        return this._process(this.eventFromException(t, i).then((t) => this._captureEvent(t, i, n))), i.event_id;
    }
    captureMessage(t, e, n, r) {
        const i = { event_id: pt(), ...n },
            s = V(t) ? t : String(t),
            o = H(t) ? this.eventFromMessage(s, e, i) : this.eventFromException(t, i);
        return this._process(o.then((t) => this._captureEvent(t, i, r))), i.event_id;
    }
    captureEvent(t, e, n) {
        const r = pt();
        if (e?.originalException && vt(e.originalException)) return c && y.log(rn), r;
        const i = { event_id: r, ...e },
    ...
    addIntegration(t) {
        ...
        Je(this, t, this._integrations), e || Ye(this, [t]);
    }
    sendEvent(t, e = {}) {
        this.emit("beforeSendEvent", t, e);
        let n = Pe(t, this._dsn, this._options._metadata, this._options.tunnel);
        for (const r of e.attachments || []) n = ye(n, Ee(r));
        this.sendEnvelope(n).then((e) => this.emit("afterSendEvent", t, e));
    }
    sendSession(t) {
        const { release: e, environment: n = pe } = this._options;
        if ("aggregates" in t) {
            const r = t.attrs || {};
            if (!r.release && !e) return void (c && y.warn(sn));
            (r.release = r.release || e), (r.environment = r.environment || n), (t.attrs = r);
        } else {
            if (!t.release && !e) return void (c && y.warn(sn));
            (t.release = t.release || e), (t.environment = t.environment || n);
        }
        this.emit("beforeSendSession", t);
        const r = (function (t, e, n, r) {
            const i = Ce(n);
            return be({ sent_at: new Date().toISOString(), ...(i && { sdk: i }), ...(!!r && e && { dsn: Yt(e) }) }, [
    ...
    recordDroppedEvent(t, e, n = 1) {
        if (this._options.sendClientReports) {
            const r = `${t}:${e}`;
            c && y.log(`Recording outcome: "${r}"${n > 1 ? ` (${n} times)` : ""}`),
    ...
    async sendEnvelope(t) {
        if ((this.emit("beforeEnvelope", t), this._isEnabled() && this._transport))
            try {
                ...
                return c && y.error("Error while sending envelope:", e), {};
            }
        return c && y.error("Transport disabled"), {};
    }
    _setupIntegrations() {
    ...
    _updateSessionFromEvent(t, e) {
        ...
        const s = "ok" === t.status;
        ((s && 0 === t.errors) || (s && n)) &&
            (xt(t, { ...(n && { status: "crashed" }), errors: t.errors || Number(r || n) }), this.captureSession(t));
    }
    ...
    _prepareEvent(t, e, n, r) {
        ...
        return (
            ...
            Fe(i, t, e, n, this, r).then((t) => {
                if (null === t) return t;
                this.emit("postprocessEvent", t, e), (t.contexts = { trace: Bt(n), ...t.contexts });
                const r = (function (t, e) {
                    const n = e.getPropagationContext();
                    return n.dsc || me(n.traceId, t);
                })(this, n);
                return (t.sdkProcessingMetadata = { dynamicSamplingContext: r, ...t.sdkProcessingMetadata }), t;
            })
        );
    }
    _captureEvent(t, e = {}, n = Ut(), r = $t()) {
        return (
            c && mn(t) && y.log(`Captured error event \`${nn(t)[0] || "<unknown>"}\``),
            this._processEvent(t, e, n, r).then(
                (t) => t.event_id,
                (t) => {
                    c && (dn(t) ? y.log(t.message) : ln(t) ? y.warn(t.message) : y.warn(t));
                }
            )
        );
    }
    _processEvent(t, e, n, r) {
        ...
        if (a && "number" == typeof l && Math.random() > l)
            return (
                ...
                ke(un(`Discarding event because it's not included in the random sample (sampling rate = ${s})`))
            );
        ...
        return this._prepareEvent(t, e, n, r)
                ...
                const n = (function (t, e, n, r) {
                    ...
                    if (fn(c)) {
                        if (o || a) {
                            ...
                            if (a?.length && le(e, a)) return null;
                            if (o) {
                                const t = o(e);
                                t
                                    ? (c = Et(n, {
                                          ...
                                          contexts: {
                                              trace: {
                                                  ...
                                                  data: {
                                                      ...u.data,
                                                      ...(u.profile_id && { [Ft]: u.profile_id }),
                                                      ...(u.exclusive_time && { [Gt]: u.exclusive_time }),
                                                  },
                                              },
                                          },
                            ...
                            if (c.spans) {
                                const e = [],
                                    n = c.spans;
                                for (const t of n)
                                    if (a?.length && le(t, a)) de(n, t);
                                    else if (o) {
                                        const n = o(t);
                                        n ? e.push(n) : (ce(), e.push(t));
                                    } else e.push(t);
                        ...
                        if (s) {
                            if (c.spans) {
                                ...
                                c.sdkProcessingMetadata = { ...n.sdkProcessingMetadata, spanCountBeforeProcessing: t };
                            }
                            return s(c, r);
                        }
                    }
            ...
            .then((i) => {
                if (null === i) {
                    ...
                    throw un(`${u} returned \`null\`, will not send event.`);
                }
                const s = n.getSession() || r.getSession();
                if ((a && s && this._updateSessionFromEvent(s, i), o)) {
                    const t =
                        (i.sdkProcessingMetadata?.spanCountBeforeProcessing || 0) - (i.spans ? i.spans.length : 0);
    ...
    _flushOutcomes() {
        c && y.log("Flushing outcomes...");
        const t = this._clearOutcomes();
        if (0 === t.length) return void (c && y.log("No outcomes to send"));
        if (!this._dsn) return void (c && y.log("No dsn provided, will not send outcomes"));
        c && y.log("Sending outcomes:", t);
        const e =
            ((n = t),
            be((r = this._options.tunnel && Yt(this._dsn)) ? { dsn: r } : {}, [
                [{ type: "client_report" }, { timestamp: bt(), discarded_events: n }],
            ]));
        var n, r;
        this.sendEnvelope(e);
    }
...
function vn(t) {
    ...
    return (
        Object.values(t).forEach((t) => {
            Array.isArray(t) ? (e += t.length * bn(t[0])) : H(t) ? (e += bn(t)) : (e += 100);
        }),
        e
    );
}
function bn(t) {
    return "string" == typeof t ? 2 * t.length : "number" == typeof t ? 8 : "boolean" == typeof t ? 4 : 0;
}
function yn(t, e) {
    !0 === e.debug && (c ? y.enable() : g(() => {}));
...
const wn = Symbol.for("SentryBufferFullError");
function Sn(t = 100) {
    const e = new Set();
    function n(t) {
        e.delete(t);
...
function xn(t, { statusCode: e, headers: n }, r = Date.now()) {
    const i = { ...t },
...
function En(t, e, n = Sn(t.bufferSize || 64)) {
    let r = {};
    return {
        send: function (i) {
            const s = [];
            ...
            return n
                .add(() =>
                    e({ body: xe(o) }).then(
                        ...
                        (t) => {
                            throw (
                                (a("network_error"), c && y.error("Encountered error running transport request:", t), t)
                            );
                        }
                    )
                )
                .then(
                    ...
                    (t) => {
                        if (t === wn)
                            return (
                                c && y.error("Skipped sending event because buffer is full."),
                                a("queue_overflow"),
                                Promise.resolve({})
                            );
                        throw t;
...
function Pn(t, e) {
    const n = jt(),
        r = $t();
    if (!n) return;
    const { beforeBreadcrumb: i = null, maxBreadcrumbs: s = Cn } = n.getOptions();
    if (s <= 0) return;
    const o = { timestamp: bt(), ...t },
        a = i ? g(() => i(o, e)) : o;
...
const kn = new WeakMap(),
    ...
    Nn = (t = {}) => ({ ...Rn(t), name: "InboundFilters" });
function In(t = {}, e = {}) {
    return {
        allowUrls: [...(t.allowUrls || []), ...(e.allowUrls || [])],
        denyUrls: [...(t.denyUrls || []), ...(e.denyUrls || [])],
        ignoreErrors: [...(t.ignoreErrors || []), ...(e.ignoreErrors || []), ...(t.disableErrorDefaults ? [] : Mn)],
...
function Dn(t) {
    try {
        ...
        return c && y.error(`Cannot extract url for event ${ft(t)}`), null;
    }
}
function Un(t, e, n, r, i, s) {
    if (!i.exception?.values || !s || !X(s.originalException, Error)) return;
    const o = i.exception.values.length > 0 ? i.exception.values[i.exception.values.length - 1] : void 0;
    o && (i.exception.values = $n(t, e, r, s.originalException, n, i.exception.values, o, 0));
}
function $n(t, e, n, r, i, s, o, a) {
    ...
    if (X(r[i], Error)) {
        ...
        const s = t(e, r[i]),
            u = c.length;
        Bn(s, i, u, a), (c = $n(t, e, n, r[i], i, [s, ...c], s, u));
    }
    return (
        Array.isArray(r.errors) &&
            r.errors.forEach((r, s) => {
                if (X(r, Error)) {
                    ...
                    const u = t(e, r),
                        l = c.length;
                    Bn(u, `errors[${s}]`, l, a), (c = $n(t, e, n, r, i, [u, ...c], u, l));
                }
            }),
        c
    );
...
function Bn(t, e, n, r) {
    t.mechanism = { handled: !0, ...t.mechanism, type: "chained", source: e, exception_id: n, parent_id: r };
}
function Fn() {
    "console" in u &&
        m.forEach(function (t) {
            t in u.console &&
                st(u.console, t, function (e) {
                    return (
                        (f[t] = e),
                        function (...e) {
                            R("console", { args: e, level: t });
                            const n = f[t];
                            n?.apply(u.console, e);
                        }
                    );
        ...
        processEvent(e) {
            ...
            try {
                if (
                    ...
                    return c && y.warn("Event dropped due to being a duplicate of previously captured event."), null;
            } catch {}
            return (t = e);
        },
    };
    ...
    if (e && "function" == typeof e.createElement)
        try {
            ...
            (n.hidden = !0),
                ...
                n.contentWindow?.fetch && (t = Xn(n.contentWindow.fetch)),
                e.head.removeChild(n);
        } catch (n) {
            c && y.warn("Could not create sandbox iframe for pure fetch check, bailing to window.fetch: ", n);
        }
    return t;
}
function Jn(t, e) {
                        ...
                        const n = new Error(),
                            { method: r, url: i } = (function (t) {
                                ...
                                if (2 === t.length) {
                                    ...
                                    return {
                                        url: Zn(e),
                                        method: Qn(n, "method") ? String(n.method).toUpperCase() : "GET",
                                    };
                                }
                                const e = t[0];
                                return { url: Zn(e), method: Qn(e, "method") ? String(e.method).toUpperCase() : "GET" };
                            })(e),
                            s = {
                                args: e,
                                fetchData: { method: r, url: i },
                                startTimestamp: 1e3 * wt(),
                                virtualError: n,
                                headers: tr(e),
                            };
                        return (
                            R("fetch", { ...s }),
                            t.apply(u, e).then(
                                async (t) => (R("fetch", { ...s, endTimestamp: 1e3 * wt(), response: t }), t),
                                (t) => {
                                    if (
                                        (R("fetch", { ...s, endTimestamp: 1e3 * wt(), error: t }),
                                        j(t) && void 0 === t.stack && ((t.stack = n.stack), ot(t, "framesToPop", 1)),
...
function Zn(t) {
    return "string" == typeof t ? t : t ? (Qn(t, "url") ? t.url : t.toString ? t.toString() : "") : "";
}
function tr(t) {
    const [e, n] = t;
    try {
        if ("object" == typeof n && null !== n && "headers" in n && n.headers) return new Headers(n.headers);
        if (((r = e), "undefined" != typeof Request && X(r, Request))) return new Headers(e.headers);
    } catch {}
    var r;
}
const er = u;
...
function ir(t, e = {}) {
        ...
        try {
            ...
            throw (
                ...
                (function (...t) {
                    ...
                    t.addEventProcessor(
                        (t) => (
                            e.mechanism && (gt(t, void 0), _t(t, e.mechanism)),
                            (t.extra = { ...t.extra, arguments: n }),
                            t
                        )
                    ),
                        (i = r),
                        Ut().captureException(i, void 0);
                }),
                r)
            );
        }
    ...
    at(n, t), ot(t, "__sentry_wrapped__", n);
    try {
...
function or(t, e, n, r) {
    const i = jt(),
        ...
        a = { __serialized__: _e(e, s) };
    if (o) return { exception: { values: [sr(t, o)] }, extra: a };
    const c = {
        exception: {
            values: [
                {
...
function ar(t, e) {
    return { exception: { values: [sr(t, e)] } };
}
function cr(t, e) {
    const n = e.stacktrace || e.stack || "",
        r = (function (t) {
            if (t && ur.test(t.message)) return 1;
            return 0;
        })(e),
        i = (function (t) {
...
function pr(t, e, n, r, i) {
    ...
    if (G(e) || B(e, "DOMException")) {
        const i = e;
        if ("stack" in e) s = ar(t, e);
        else {
            const e = i.name || (G(i) ? "DOMError" : "DOMException"),
                o = i.message ? `${e}: ${i.message}` : e;
            (s = mr(t, o, n, r)), gt(s, o);
        }
        return "code" in i && (s.tags = { ...s.tags, "DOMException.code": `${i.code}` }), s;
    }
    if (j(e)) return ar(t, e);
    if (W(e) || q(e)) {
        return (s = or(t, e, n, i)), _t(s, { synthetic: !0 }), s;
    }
    return (s = mr(t, e, n, r)), gt(s, `${e}`), _t(s, { synthetic: !0 }), s;
}
function mr(t, e, n, r) {
    const i = {};
    if (r && n) {
        const r = cr(t, n);
        r.length && (i.exception = { values: [{ value: e, stacktrace: { frames: r } }] }), _t(i, { synthetic: !0 });
    }
    if (V(e)) {
...
function fr(t, { isUnhandledRejection: e }) {
    const n = (function (t, e = 40) {
            const n = Object.keys(ut(t));
            n.sort();
            const r = n[0];
            if (!r) return "[object has no keys]";
            if (r.length >= e) return et(r, e);
            for (let i = n.length; i > 0; i--) {
                const t = n.slice(0, i).join(", ");
                if (!(t.length > e)) return i === n.length ? t : et(t, e);
            }
            return "";
        })(t),
        r = e ? "promise rejection" : "exception";
    if (F(t)) return `Event \`ErrorEvent\` captured as ${r} with message \`${t.message}\``;
    if (q(t)) {
        ...
        !(function (t, e, n = [e], r = "npm") {
            ...
            i.sdk ||
                (i.sdk = {
                    ...
                    packages: n.map((t) => ({ name: `${r}:@sentry/${t}`, version: l })),
                    version: l,
                }),
                (t._metadata = i);
        })(e, "browser", ["browser"], er.SENTRY_SDK_SOURCE || "npm"),
            e._metadata?.sdk &&
            ...
            super(e);
        const { sendDefaultPii: r, sendClientReports: i, enableLogs: s, _experiments: o } = this._options;
        er.document &&
            (i || s || o?.enableMetrics) &&
            er.document.addEventListener("visibilitychange", () => {
                "hidden" === er.document.visibilityState &&
                    (i && this._flushOutcomes(), s && Qe(this), o?.enableMetrics && tn(this));
            }),
            r && this.on("beforeSendSession", An);
    }
    eventFromException(t, e) {
        return (function (t, e, n, r) {
            const i = pr(t, e, n?.syntheticException || void 0, r);
            return _t(i), (i.level = "error"), n?.event_id && (i.event_id = n.event_id), Oe(i);
        })(this._options.stackParser, t, e, this._options.attachStacktrace);
    }
    eventFromMessage(t, e = "info", n) {
        return (function (t, e, n = "info", r, i) {
            const s = mr(t, e, r?.syntheticException || void 0, i);
            return (s.level = n), r?.event_id && (s.event_id = r.event_id), Oe(s);
...
const _r = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__,
    vr = u;
let br, yr, wr, Sr;
function xr() {
    if (!vr.document) return;
    const t = R.bind(null, "dom"),
        e = Er(t, !0);
    vr.document.addEventListener("click", e, !1),
        vr.document.addEventListener("keypress", e, !1),
        ["EventTarget", "Node"].forEach((e) => {
            const n = vr,
                r = n[e]?.prototype;
            r?.hasOwnProperty?.("addEventListener") &&
                (st(r, "addEventListener", function (e) {
                ...
                st(r, "removeEventListener", function (t) {
    ...
    return (n) => {
        ...
        if (
            (function (t, e) {
                return (
                    "keypress" === t &&
                    (!e?.tagName || ("INPUT" !== e.tagName && "TEXTAREA" !== e.tagName && !e.isContentEditable))
                );
            })(n.type, r)
        )
            return;
        ot(n, "_sentryCaptured", !0), r && !r._sentryId && ot(r, "_sentryId", pt());
        const i = "keypress" === n.type ? "input" : n.type;
        if (
            !(function (t) {
                if (t.type !== yr) return !1;
                try {
                    if (!t.target || t.target._sentryId !== wr) return !1;
                } catch {}
                return !0;
            })(n)
        ) {
            t({ event: n, name: i, global: e }), (yr = n.type), (wr = r ? r._sentryId : void 0);
        }
        clearTimeout(br),
            (br = vr.setTimeout(() => {
                (wr = void 0), (yr = void 0);
        ...
        return function (...e) {
            ...
            if (n) {
                const r = Sr,
                    i = (function (t) {
                        try {
                            return new URL(t, vr.location.origin).toString();
                        } catch {
                            return t;
                        }
                    })(String(n));
                if (((Sr = i), r === i)) return t.apply(this, e);
                R("history", { from: r, to: i });
            }
            return t.apply(this, e);
        };
    }
    vr.addEventListener("popstate", () => {
        const t = vr.location.href,
            e = Sr;
        if (((Sr = t), e === t)) return;
        R("history", { from: e, to: t });
    }),
        "history" in Kn && Kn.history && (st(vr.history, "pushState", t), st(vr.history, "replaceState", t));
}
const Cr = {};
const Pr = "__sentry_xhr_v3__";
function Or() {
    if (!vr.XMLHttpRequest) return;
    const t = XMLHttpRequest.prototype;
    (t.open = new Proxy(t.open, {
        apply(t, e, n) {
            const r = new Error(),
                i = 1e3 * wt(),
                s = z(n[0]) ? n[0].toUpperCase() : void 0,
                o = (function (t) {
                    if (z(t)) return t;
                    try {
                        return t.toString();
            ...
            (e[Pr] = { method: s, url: o, request_headers: {} }),
            ...
            const a = () => {
                ...
                if (t && 4 === e.readyState) {
                    ...
                    R("xhr", { endTimestamp: 1e3 * wt(), startTimestamp: i, xhr: e, virtualError: r });
                }
            };
            return (
                ...
                (e.setRequestHeader = new Proxy(e.setRequestHeader, {
                    apply(t, e, n) {
                        const [r, i] = n,
                            s = e[Pr];
                        return s && z(r) && z(i) && (s.request_headers[r.toLowerCase()] = i), t.apply(e, n);
                    },
                })),
                t.apply(e, n)
            );
        ...
        (t.send = new Proxy(t.send, {
            apply(t, e, n) {
                ...
                return R("xhr", { startTimestamp: 1e3 * wt(), xhr: e }), t.apply(e, n);
            },
        }));
}
function kr(
    ...
    e = (function (t) {
        ...
        if (r && "function" == typeof r.createElement)
            try {
                ...
                _r && y.warn(`Could not create sandbox iframe for ${t} check, bailing to window.${t}: `, i);
            }
        return n ? (Cr[t] = n.bind(vr)) : n;
    })("fetch")
) {
    let n = 0,
        r = 0;
    return En(t, async function (i) {
...
function Lr(t, e, n, r) {
    const i = { filename: t, function: "<anonymous>" === e ? w : e, in_app: !0 };
    return void 0 !== n && (i.lineno = n), void 0 !== r && (i.colno = r), i;
}
const Mr = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
    Rr =
    ...
    Ur = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
    $r = E(
        ...[
            [
                30,
                (t) => {
                    ...
                    if (r) {
                        ...
                        const [t, e] = jr(r[1] || w, r[2]);
                        return Lr(e, t, r[3] ? +r[3] : void 0, r[4] ? +r[4] : void 0);
                    }
                },
            ],
            [
                ...
                (t) => {
                    ...
                    if (e) {
                        ...
                        let t = e[3],
                            n = e[1] || w;
                        return ([n, t] = jr(n, t)), Lr(t, n, e[4] ? +e[4] : void 0, e[5] ? +e[5] : void 0);
                    }
                },
            ],
        ]
    ...
    jr = (t, e) => {
        ...
        return n || r
            ? [-1 !== t.indexOf("@") ? t.split("@")[0] : w, n ? `safari-extension:${e}` : `safari-web-extension:${e}`]
            : [t, e];
    },
                    ...
                    (function (t) {
                        ...
                        (function (t) {
                            return function (e) {
                                ...
                                Pn(n, { input: e.args, level: e.level });
                            };
                        })(t)
                    ),
                    e.dom &&
                        ((n = (function (t, e) {
                            return function (n) {
                                ...
                                try {
                                    const t = n.event,
                                        e = (function (t) {
                                            ...
                                            ? t.target
                                            : t;
                                    (r = Q(e, { keyAttrs: s, maxStringLength: o })),
                                        (i = (function (t) {
                                ...
                                i && (a.data = { "ui.component_name": i }),
                                    Pn(a, { event: n.event, name: n.name, global: n.global });
                            };
                        })(t, e.dom)),
                        L("dom", n),
                        M("dom", xr)),
                            ...
                            (function (t) {
                                return function (e) {
                                    ...
                                    const { method: s, url: o, status_code: a, body: c } = i,
                                        ...
                                        d = { category: "xhr", data: u, type: "http", level: qn(a) };
                                    t.emit("beforeOutgoingRequestBreadcrumb", d, l), Pn(d, l);
                                };
                            })(t)
                        ),
                    e.fetch &&
                                ...
                                return function (e) {
                                    ...
                                    if (r && (!e.fetchData.url.match(/sentry_key/) || "POST" !== e.fetchData.method))
                                        if ((e.fetchData.method, e.fetchData.url, e.error)) {
                                            ...
                                            t.emit("beforeOutgoingRequestBreadcrumb", o, s), Pn(o, s);
                                        } else {
                                            const i = e.response,
                                            ...
                                            const o = {
                                                ...
                                                a = {
                                                    ...
                                                    data: s,
                                                    type: "http",
                                                    level: qn(s.status_code),
                                                };
                                            t.emit("beforeOutgoingRequestBreadcrumb", a, o), Pn(a, o);
                                        }
                                };
                            })(t)
                        ),
...
const zr = [
    ...
    Vr = (t = {}) => {
        ...
        return {
            ...
            setupOnce() {
                e.setTimeout && st(er, "setTimeout", Hr),
                    e.setInterval && st(er, "setInterval", Hr),
                    e.requestAnimationFrame && st(er, "requestAnimationFrame", Wr),
                    e.XMLHttpRequest && "XMLHttpRequest" in er && st(XMLHttpRequest.prototype, "send", qr);
                const t = e.eventTarget;
                if (t) {
                    (Array.isArray(t) ? t : zr).forEach((t) =>
                        (function (t, e) {
                            const n = er,
                                r = n[t]?.prototype;
                            if (!r?.hasOwnProperty?.("addEventListener")) return;
                            st(r, "addEventListener", function (n) {
                                return function (r, i, s) {
                                    try {
                                        "function" == typeof i.handleEvent &&
                                            (i.handleEvent = ir(i.handleEvent, {
                                                mechanism: {
                                                    data: { handler: C(i), target: t },
                                                    handled: !1,
...
function Hr(t) {
    return function (...e) {
        const n = e[0];
        return (
            (e[0] = ir(n, { mechanism: { handled: !1, type: `auto.browser.browserapierrors.${C(t)}` } })),
            t.apply(this, e)
        );
    };
}
                ...
                t in n &&
                    ...
                    st(n, t, function (e) {
                        const n = {
                            ...
                            r = ct(e);
                        return r && (n.mechanism.data.handler = C(r)), ir(e, n);
                    });
            }),
            t.apply(this, e)
        );
        ...
        setupOnce() {
            void 0 !== er.document
                ? (ze({ ignoreDuration: !0 }),
                  We(),
                  Tr(({ from: t, to: e }) => {
                      void 0 !== t && t !== e && (ze({ ignoreDuration: !0 }), We());
                  }))
                : Br && y.warn("Using the `browserSessionIntegration` in non-browser environments is not supported.");
        },
    }),
    Xr = (t = {}) => {
            ...
            setup(t) {
                e.onerror &&
                        ...
                        !(function (t) {
                            ...
                            const { msg: i, url: s, line: o, column: a, error: c } = e,
                                u = (function (t, e, n, r) {
                                    ...
                                    0 === c.length &&
                                        c.push({ colno: u, filename: d, function: w, in_app: !0, lineno: l });
                                    return t;
                                })(pr(n, c || i, void 0, r, !1), s, o, a);
                            (u.level = "error"),
                                Ge(u, {
                                    originalException: c,
                    ...
                    e.onunhandledrejection &&
                        ...
                        Yr("onunhandledrejection"));
            },
        };
    };
function Yr(t) {
    Br && y.log(`Global Handler attached: ${t}`);
}
function Jr() {
    const t = jt();
...
const Qr = () => ({
        ...
        preprocessEvent(t) {
            ...
            const e = (function () {
                    const t = tt(),
                        { referrer: e } = er.document || {},
                        { userAgent: n } = er.navigator || {};
    ...
    Zr = (t = {}) => {
        ...
        return {
            ...
            preprocessEvent(t, r, i) {
                Un(sr, i.getOptions().stackParser, n, e, t, r);
            },
        };
    };
function ti() {
    return (
        !!(function () {
            ...
            return !(er === er.top && r.some((t) => n.startsWith(`${t}://`)));
        })() && (Br && g(() => {}), !0)
    );
}
function ei(t) {
    return [Nn(), Ln(), Vr(), Gr(), Xr(), Zr(), zn(), Qr(), Kr()];
}
const ni = () => {
    const t = ei().filter((t) => !["BrowserApiErrors", "Breadcrumbs", "GlobalHandlers"].includes(t.name));
    !(function (t = {}) {
        const e = !t.skipBrowserExtensionCheck && ti(),
            n = {
                ...t,
                enabled: !e && t.enabled,
                stackParser: ((r = t.stackParser || $r), Array.isArray(r) ? E(...r) : r),
                integrations: Xe({
                    integrations: t.integrations,
                    defaultIntegrations: null == t.defaultIntegrations ? ei() : t.defaultIntegrations,
                }),
                transport: t.transport || kr,
            };
        var r;
        yn(gr, n);
    })({
        ...
        stackParser: $r,
        integrations: t,
        initialScope: { tags: { extension_version: chrome.runtime.getManifest().version } },
        beforeSend: (t) => (
            (t.contexts = {
                ...t.contexts,
                extension: {
...
var oi = (function (t) {
        ...
        return function (t) {
            ...
            var u = +r[1],
                l = +r[2],
                d = +r[3];
            return null != r[4] || i !== u ? a(t) : 0 === i ? (s === l && o <= d ? c(t) : a(t)) : s <= l ? c(t) : a(t);
        };
    })(ii),
    ai = ii.split(".")[0],
    ci = Symbol.for("opentelemetry.js.api." + ai),
    ui = ri;
function li(t, e, n, r) {
    var i;
    void 0 === r && (r = !1);
    var s = (ui[ci] = null !== (i = ui[ci]) && void 0 !== i ? i : { version: ii });
    if (!r && s[t]) {
    ...
    return (s[t] = e), n.debug("@opentelemetry/api: Registered a global for " + t + " v" + ii + "."), !0;
}
function di(t) {
    var e,
        n,
        r = null === (e = ui[ci]) || void 0 === e ? void 0 : e.version;
    if (r && oi(r)) return null === (n = ui[ci]) || void 0 === n ? void 0 : n[t];
}
function hi(t, e) {
    e.debug("@opentelemetry/api: Unregistering a global for " + t + " v" + ii + ".");
    var n = ui[ci];
    n && delete n[t];
}
var pi,
    mi,
        ...
        return (
            (t.prototype.debug = function () {
                ...
                return gi("debug", this._namespace, t);
            }),
            (t.prototype.error = function () {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return gi("error", this._namespace, t);
            }),
            (t.prototype.info = function () {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return gi("info", this._namespace, t);
            }),
            (t.prototype.warn = function () {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return gi("warn", this._namespace, t);
            }),
            (t.prototype.verbose = function () {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return gi("verbose", this._namespace, t);
            }),
            t
        );
    })();
...
((mi = pi || (pi = {}))[(mi.NONE = 0)] = "NONE"),
    (mi[(mi.ERROR = 30)] = "ERROR"),
    (mi[(mi.WARN = 50)] = "WARN"),
    (mi[(mi.INFO = 60)] = "INFO"),
    (mi[(mi.DEBUG = 70)] = "DEBUG"),
    (mi[(mi.VERBOSE = 80)] = "VERBOSE"),
    (mi[(mi.ALL = 9999)] = "ALL");
var _i = (function () {
        function t() {
            function t(t) {
            ...
            (e.setLogger = function (t, n) {
                var r, i, s;
                if ((void 0 === n && (n = { logLevel: pi.INFO }), t === e)) {
                    var o = new Error(
                ...
                var a = di("diag"),
                    c = (function (t, e) {
                        ...
                        return (
                            t < pi.NONE ? (t = pi.NONE) : t > pi.ALL && (t = pi.ALL),
                            (e = e || {}),
                            {
                                error: n("error", pi.ERROR),
                                warn: n("warn", pi.WARN),
                                info: n("info", pi.INFO),
                                debug: n("debug", pi.DEBUG),
                                verbose: n("verbose", pi.VERBOSE),
                            }
                        );
                    })(null !== (i = n.logLevel) && void 0 !== i ? i : pi.INFO, t);
    ...
    bi = Symbol("BaggageEntryMetadata"),
    yi = _i.instance();
function wi(t) {
    return void 0 === t && (t = {}), new vi(new Map(Object.entries(t)));
}
function Si(t) {
    return Symbol.for(t);
}
var xi,
    ...
    Ci = (function () {
        return function () {
            ...
            for (var e = 0; e < Ai.length; e++) this[Ai[e].n] = t(Ai[e].c);
        };
    })(),
    Pi = (function () {
        var t = function (e, n) {
    ...
    Li = (function (t) {
        ...
        return Pi(e, t), (e.prototype.add = function (t, e) {}), e;
    })(ki),
    Mi = (function (t) {
        function e() {
            return (null !== t && t.apply(this, arguments)) || this;
    ...
    Ri = (function (t) {
        ...
        return Pi(e, t), (e.prototype.record = function (t, e) {}), e;
    })(ki),
    Ni = (function (t) {
        function e() {
            return (null !== t && t.apply(this, arguments)) || this;
    ...
    Hi = new Ui(),
    Wi = new $i();
((Ei = xi || (xi = {}))[(Ei.INT = 0)] = "INT"), (Ei[(Ei.DOUBLE = 1)] = "DOUBLE");
var qi,
    Ki,
    Xi = {
        get: function (t, e) {
    ...
    ts = (function () {
        ...
        return (
            ...
            (t.prototype.disable = function () {
                this._getContextManager().disable(), hi(Qi, _i.instance());
            }),
            t
        );
    })();
((Ki = qi || (qi = {}))[(Ki.NONE = 0)] = "NONE"), (Ki[(Ki.SAMPLED = 1)] = "SAMPLED");
var es = "0000000000000000",
    ns = "00000000000000000000000000000000",
    rs = { traceId: ns, spanId: es, traceFlags: qi.NONE },
    is = (function () {
        function t(t) {
            void 0 === t && (t = rs), (this._spanContext = t);
        }
        return (
    ...
    ss = Si("OpenTelemetry Context Key SPAN");
function os(t) {
    return t.getValue(ss) || void 0;
}
function as() {
    return os(ts.getInstance().active());
}
function cs(t, e) {
    return t.setValue(ss, e);
}
function us(t) {
    return t.deleteValue(ss);
}
function ls(t, e) {
    return cs(t, new is(e));
}
function ds(t) {
    var e;
    return null === (e = os(t)) || void 0 === e ? void 0 : e.spanContext();
}
var hs = /^([0-9a-f]{32})$/i,
    ps = /^[0-9a-f]{16}$/i;
function ms(t) {
    return hs.test(t) && t !== ns;
}
function fs(t) {
    return ms(t.traceId) && ((e = t.spanId), ps.test(e) && e !== es);
    var e;
}
function gs(t) {
    return new is(t);
}
var _s = ts.getInstance(),
    vs = (function () {
        function t() {}
        return (
            (t.prototype.startSpan = function (t, e, n) {
                if ((void 0 === n && (n = _s.active()), Boolean(null == e ? void 0 : e.root))) return new is();
                var r,
                    i = n && ds(n);
                ...
                if (!(arguments.length < 2)) {
                    2 === arguments.length
                        ...
                        : 3 === arguments.length
                          ? ((i = e), (o = n))
                          : ((i = e), (s = n), (o = r));
                    var a = null != s ? s : _s.active(),
                        c = this.startSpan(t, i, a),
                        u = cs(a, c);
                    return _s.with(u, o, void 0, c);
                }
            }),
            t
        );
...
var bs,
    ...
    As = (function () {
        ...
        return (
            ...
            (t.prototype._getTracer = function () {
                ...
                return t ? ((this._delegate = t), this._delegate) : Ts;
            }),
            t
        );
    })(),
    ...
    Ps = (function () {
        ...
        return (
            (t.prototype.getTracer = function (t, e, n) {
                var r;
                return null !== (r = this.getDelegateTracer(t, e, n)) && void 0 !== r ? r : new As(this, t, e, n);
            }),
            (t.prototype.getDelegate = function () {
                var t;
                return null !== (t = this._delegate) && void 0 !== t ? t : Cs;
            }),
...
((ys = bs || (bs = {}))[(ys.NOT_RECORD = 0)] = "NOT_RECORD"),
    (ys[(ys.RECORD = 1)] = "RECORD"),
    (ys[(ys.RECORD_AND_SAMPLED = 2)] = "RECORD_AND_SAMPLED"),
    ((Ss = ws || (ws = {}))[(Ss.INTERNAL = 0)] = "INTERNAL"),
    (Ss[(Ss.SERVER = 1)] = "SERVER"),
    (Ss[(Ss.CLIENT = 2)] = "CLIENT"),
    (Ss[(Ss.PRODUCER = 3)] = "PRODUCER"),
    (Ss[(Ss.CONSUMER = 4)] = "CONSUMER"),
    ((Es = xs || (xs = {}))[(Es.UNSET = 0)] = "UNSET"),
    (Es[(Es.OK = 1)] = "OK"),
    (Es[(Es.ERROR = 2)] = "ERROR");
var Os = ts.getInstance(),
    ks = _i.instance(),
    Ls = new ((function () {
        function t() {}
        return (
    ...
    Is = Si("OpenTelemetry Baggage Key");
function Ds(t) {
    return t.getValue(Is) || void 0;
}
function Us() {
    return Ds(ts.getInstance().active());
}
function $s(t, e) {
    return t.setValue(Is, e);
}
function js(t) {
    return t.deleteValue(Is);
}
var Bs = "propagation",
    Fs = new Ns(),
    Gs = (function () {
        function t() {
            (this.createBaggage = wi),
                (this.getBaggage = Ds),
                (this.getActiveBaggage = Us),
                (this.setBaggage = $s),
                (this.deleteBaggage = js);
        }
        return (
            (t.getInstance = function () {
                return this._instance || (this._instance = new t()), this._instance;
            ...
            (t.prototype.setGlobalPropagator = function (t) {
                return li(Bs, t, _i.instance());
            }),
            (t.prototype.inject = function (t, e, n) {
                return void 0 === n && (n = Yi), this._getGlobalPropagator().inject(t, e, n);
            }),
            (t.prototype.extract = function (t, e, n) {
                return void 0 === n && (n = Xi), this._getGlobalPropagator().extract(t, e, n);
            }),
            (t.prototype.fields = function () {
    ...
    Vs = (function () {
        function t() {
            (this._proxyTracerProvider = new Ps()),
                (this.wrapSpanContext = gs),
                (this.isSpanContextValid = fs),
                (this.deleteSpan = us),
                (this.getSpan = os),
                (this.getActiveSpan = as),
                (this.getSpanContext = ds),
                (this.setSpan = cs),
        ...
        return (
            ...
            (t.prototype.setGlobalTracerProvider = function (t) {
                var e = li(zs, this._proxyTracerProvider, _i.instance());
                return e && this._proxyTracerProvider.setDelegate(t), e;
            }),
            (t.prototype.getTracerProvider = function () {
                return di(zs) || this._proxyTracerProvider;
            }),
            (t.prototype.getTracer = function (t, e) {
                return this.getTracerProvider().getTracer(t, e);
            }),
            (t.prototype.disable = function () {
                hi(zs, _i.instance()), (this._proxyTracerProvider = new Ps());
            }),
            t
        );
    })().getInstance();
...
let Ks = class {
    ...
    Xs = class {
        getLogger(t, e, n) {
            var r;
            return null !== (r = this.getDelegateLogger(t, e, n)) && void 0 !== r ? r : new Ks(this, t, e, n);
        }
        getDelegate() {
            var t;
            return null !== (t = this._delegate) && void 0 !== t ? t : qs;
        }
        setDelegate(t) {
            this._delegate = t;
        }
            ...
            : "object" == typeof self
              ...
              : "object" == typeof window
                ...
                : "object" == typeof global
                  ? global
                  : {},
    Js = Symbol.for("io.opentelemetry.js.api.logs"),
    Qs = Ys;
const Zs = class t {
    constructor() {
        this._proxyLoggerProvider = new Xs();
    }
    static getInstance() {
        return this._instance || (this._instance = new t()), this._instance;
    }
    ...
    getLoggerProvider() {
        var t, e;
        return null !== (e = null === (t = Qs[Js]) || void 0 === t ? void 0 : t.call(Qs, 1)) && void 0 !== e
            ? e
    ...
    disable() {
        delete Qs[Js], (this._proxyLoggerProvider = new Xs());
    }
}.getInstance();
const to = "service.name",
    eo = "telemetry.sdk.language",
    no = "telemetry.sdk.name",
    ro = "telemetry.sdk.version",
    io = "process.runtime.name",
    so = { [no]: "opentelemetry", [io]: "browser", [eo]: "webjs", [ro]: "2.0.1" };
const oo = (t) => null !== t && "object" == typeof t && "function" == typeof t.then;
class ao {
    _rawAttributes;
    ...
    static FromAttributeList(t) {
        const e = new ao({});
        return (e._rawAttributes = ho(t)), (e._asyncAttributesPending = t.filter(([t, e]) => oo(e)).length > 0), e;
    }
    constructor(t) {
        const e = t.attributes ?? {};
        (this._rawAttributes = Object.entries(e).map(
            ([t, e]) => (oo(e) && (this._asyncAttributesPending = !0), [t, e])
        )),
            (this._rawAttributes = ho(this._rawAttributes));
    }
    ...
    async waitForAsyncAttributes() {
        if (this.asyncAttributesPending) {
            for (let t = 0; t < this._rawAttributes.length; t++) {
                ...
                this._rawAttributes[t] = [e, oo(n) ? await n : n];
            }
    ...
    get attributes() {
        if (
            (this.asyncAttributesPending && ks.error("Accessing resource attributes before async attributes settled"),
            this._memoizedAttributes)
        )
            return this._memoizedAttributes;
        const t = {};
        for (const [e, n] of this._rawAttributes)
            oo(n) ? ks.debug(`Unsettled resource attribute ${e} skipped`) : null != n && (t[e] ??= n);
    ...
    merge(t) {
        return null == t ? this : ao.FromAttributeList([...t.getRawAttributes(), ...this.getRawAttributes()]);
    }
}
function co(t) {
    return ao.FromAttributeList(Object.entries(t));
}
function uo() {
    return co({});
}
function lo() {
    return co({ [to]: "unknown_service", [eo]: so[eo], [no]: so[no], [ro]: so[ro] });
}
function ho(t) {
    return t.map(([t, e]) =>
        oo(e)
            ? [
                  t,
                  e.catch((e) => {
                      ks.debug("promise rejection for resource attribute: %s - %s", t, e);
                  }),
              ]
            : [t, e]
    );
...
const po = (t = {}) =>
        (t.detectors || [])
            .map((e) => {
                try {
                    const r = ((n = e.detect(t)), new ao(n));
                    return ks.debug(`${e.constructor.name} found resource.`, r), r;
                } catch (r) {
                    return ks.debug(`${e.constructor.name} failed: ${r.message}`), uo();
                }
                var n;
            })
            .reduce((t, e) => t.merge(e), uo()),
    mo = Si("OpenTelemetry SDK Context Key SUPPRESS_TRACING");
function fo(t) {
    const e = {};
        ...
        go(n)
            ? _o(r)
                ? Array.isArray(r)
                    ? (e[n] = r.slice())
                    : (e[n] = r)
                : ks.warn(`Invalid attribute value set for key: ${n}`)
            : ks.warn(`Invalid attribute key: ${n}`);
    return e;
}
function go(t) {
...
const wo = performance,
    So = "exception.message",
    xo = "exception.type";
const Eo = Math.pow(10, 6),
    To = Math.pow(10, 9);
function Ao(t) {
    const e = t / 1e3;
    return [Math.trunc(e), Math.round((t % 1e3) * Eo)];
}
function Co() {
    let t = wo.timeOrigin;
    if ("number" != typeof t) {
...
function Oo(t) {
    return Po(t) || "number" == typeof t || t instanceof Date;
}
function ko(t, e) {
    const n = [t[0] + e[0], t[1] + e[1]];
    return n[1] >= To && ((n[1] -= To), (n[0] += 1)), n;
}
var Lo, Mo;
((Mo = Lo || (Lo = {}))[(Mo.SUCCESS = 0)] = "SUCCESS"), (Mo[(Mo.FAILED = 1)] = "FAILED");
const Ro = "[object Null]",
    No = "[object Undefined]",
    ...
    $o = Object.prototype,
    jo = $o.hasOwnProperty,
    Bo = Symbol ? Symbol.toStringTag : void 0,
    Fo = $o.toString;
function Go(t) {
    if (
        !(function (t) {
        ...
        "[object Object]" !==
            (function (t) {
                if (null == t) return void 0 === t ? No : Ro;
                return Bo && Bo in Object(t)
                    ? (function (t) {
                          const e = jo.call(t, Bo),
                              n = t[Bo];
                          let r = !1;
                          try {
                              (t[Bo] = void 0), (r = !0);
    ...
    const e = Uo(t);
    if (null === e) return !0;
    const n = jo.call(e, "constructor") && e.constructor;
    return "function" == typeof n && n instanceof n && Io.call(n) === Do;
}
function zo(t) {
    return Wo(t) ? t.slice() : t;
}
function Vo(t, e, n = 0, r) {
    let i;
    if (!(n > 20)) {
        if ((n++, Xo(t) || Xo(e) || qo(e))) i = zo(e);
        else if (Wo(t)) {
            if (((i = t.slice()), Wo(e))) for (let t = 0, n = e.length; t < n; t++) i.push(zo(e[t]));
            else if (Ko(e)) {
            ...
            if (Ko(e)) {
                ...
                for (let o = 0, a = s.length; o < a; o++) {
                    const a = s[o],
                        c = e[a];
                    if (Xo(c)) void 0 === c ? delete i[a] : (i[a] = c);
                    else {
                        const s = i[a],
                            o = c;
                        if (Ho(t, a, r) || Ho(e, a, r)) delete i[a];
                        else {
                            if (Ko(s) && Ko(o)) {
                                const n = r.get(s) || [],
                                    i = r.get(o) || [];
...
function Ko(t) {
    return !Xo(t) && !Wo(t) && !qo(t) && "object" == typeof t;
}
function Xo(t) {
    return (
        "string" == typeof t ||
...
class Qo {
    ...
    constructor(t) {
        ...
        (this._spanContext = t.spanContext),
            (this._performanceStartTime = wo.now()),
            (this._performanceOffset = e - (this._performanceStartTime + Co())),
    ...
    setAttribute(t, e) {
        ...
        if (0 === t.length) return ks.warn(`Invalid attribute key: ${t}`), this;
        if (!_o(e)) return ks.warn(`Invalid attribute value set for key: ${t}`), this;
    ...
    addEvent(t, e, n) {
        ...
        if (0 === r) return ks.warn("No events allowed."), this._droppedEventsCount++, this;
        void 0 !== r &&
            this.events.length >= r &&
            (0 === this._droppedEventsCount && ks.debug("Dropping extra events."),
            this.events.shift(),
            this._droppedEventsCount++),
            Oo(e) && (Oo(n) || (n = e), (e = void 0));
        const i = fo(e);
        return this.events.push({ name: t, attributes: i, time: this._getTime(n), droppedAttributesCount: 0 }), this;
    }
    addLink(t) {
        ...
        return (
            this._isSpanEnded() ||
                ...
                null != this.status.message &&
                    ...
                    (ks.warn(`Dropping invalid status.message of type '${typeof t.message}', expected 'string'`),
        ...
        this._isSpanEnded()
            ...
            : ((this._ended = !0),
              ...
              this._droppedEventsCount > 0 &&
                  ks.warn(`Dropped ${this._droppedEventsCount} events because eventCountLimit reached`),
              this._spanProcessor.onEnd(this));
    }
    _getTime(t) {
        if ("number" == typeof t && t <= wo.now())
            return (e = t + this._performanceOffset), ko(Ao(Co()), Ao("number" == typeof e ? e : wo.now()));
        var e;
        if ("number" == typeof t) return Ao(t);
        if (t instanceof Date) return Ao(t.getTime());
        if (Po(t)) return t;
        if (this._startTimeProvided) return Ao(Date.now());
        const n = wo.now() - this._performanceStartTime;
        return ko(this.startTime, Ao(n));
    }
    isRecording() {
    ...
    recordException(t, e) {
        ...
        "string" == typeof t
            ? (n[So] = t)
            : t &&
              (t.code ? (n[xo] = t.code.toString()) : t.name && (n[xo] = t.name),
              t.message && (n[So] = t.message),
              t.stack && (n["exception.stacktrace"] = t.stack)),
            n[xo] || n[So] ? this.addEvent("exception", n, e) : ks.warn(`Failed to record an exception ${t}`);
    }
    get duration() {
    ...
    _truncateToSize(t) {
        ...
        return e <= 0
            ? (ks.warn(`Attribute value limit must be positive, got ${e}`), t)
            : "string" == typeof t
...
class ea {
    shouldSample() {
        return { decision: Zo.RECORD_AND_SAMPLED };
    }
    toString() {
...
class na {
    ...
    constructor(t) {
        (this._root = t.root),
            this._root ||
                (yo(new Error("ParentBasedSampler must have a root sampler configured")), (this._root = new ea())),
            (this._remoteParentSampled = t.remoteParentSampled ?? new ea()),
            (this._remoteParentNotSampled = t.remoteParentNotSampled ?? new ta()),
            (this._localParentSampled = t.localParentSampled ?? new ea()),
            (this._localParentNotSampled = t.localParentNotSampled ?? new ta());
    }
    shouldSample(t, e, n, r, i, s) {
        const o = Vs.getSpanContext(t);
        return o && fs(o)
            ? o.isRemote
                ? o.traceFlags & qi.SAMPLED
...
class ra {
    ...
    shouldSample(t, e) {
        return { decision: ms(e) && this._accumulate(e) < this._upperBound ? Zo.RECORD_AND_SAMPLED : Zo.NOT_RECORD };
    }
    toString() {
...
function sa() {
    ...
    switch (t) {
        ...
        case "parentbased_always_on":
            return new na({ root: new ea() });
        case "parentbased_always_off":
            return new na({ root: new ta() });
        case "traceidratio":
            return new ra(oa());
        case "parentbased_traceidratio":
            return new na({ root: new ra(oa()) });
        default:
            return (
                ks.error(`OTEL_TRACES_SAMPLER value "${t}" invalid, defaulting to "parentbased_always_on".`),
                new na({ root: new ea() })
            );
    }
}
function oa() {
    return ks.error("OTEL_TRACES_SAMPLER_ARG is blank, defaulting to 1."), 1;
}
const aa = 1 / 0;
class ca {
    _exporter;
    ...
    constructor(t, e) {
        (this._exporter = t),
            (this._maxExportBatchSize = "number" == typeof e?.maxExportBatchSize ? e.maxExportBatchSize : 512),
            (this._maxQueueSize = "number" == typeof e?.maxQueueSize ? e.maxQueueSize : 2048),
            (this._scheduledDelayMillis = "number" == typeof e?.scheduledDelayMillis ? e.scheduledDelayMillis : 5e3),
            (this._exportTimeoutMillis = "number" == typeof e?.exportTimeoutMillis ? e.exportTimeoutMillis : 3e4),
            (this._shutdownOnce = new Jo(this._shutdown, this)),
    ...
    onStart(t, e) {}
    onEnd(t) {
        this._shutdownOnce.isCalled || (0 !== (t.spanContext().traceFlags & qi.SAMPLED) && this._addToBuffer(t));
    }
    shutdown() {
    ...
    _addToBuffer(t) {
        if (this._finishedSpans.length >= this._maxQueueSize)
            return (
                0 === this._droppedSpansCount && ks.debug("maxQueueSize reached, dropping spans"),
                void this._droppedSpansCount++
            );
        this._droppedSpansCount > 0 &&
            (ks.warn(`Dropped ${this._droppedSpansCount} spans because maxQueueSize reached`),
            (this._droppedSpansCount = 0)),
        ...
        return (
            ...
            0 === this._finishedSpans.length
                ...
                : new Promise((t, e) => {
                      ...
                      Os.with(Os.active().setValue(mo, !0), () => {
                          let r;
...
class la {
    generateTraceId = ha(16);
    generateSpanId = ha(8);
}
const da = Array(32);
function ha(t) {
    return function () {
        for (let e = 0; e < 2 * t; e++) (da[e] = Math.floor(16 * Math.random()) + 48), da[e] >= 58 && (da[e] += 39);
        return String.fromCharCode.apply(null, da.slice(0, 2 * t));
    };
}
class pa {
    _sampler;
    ...
    constructor(t, e, n, r) {
        ...
        (this._sampler = i.sampler),
            ...
            (this._idGenerator = e.idGenerator || new la()),
            (this._resource = n),
            (this._spanProcessor = r),
            (this.instrumentationScope = t);
    }
    startSpan(t, e = {}, n = Os.active()) {
        e.root && (n = Vs.deleteSpan(n));
        const r = Vs.getSpan(n);
        if (!0 === n.getValue(mo)) {
            ks.debug("Instrumentation suppressed, returning Noop Span");
            return Vs.wrapSpanContext(rs);
        }
        const i = r?.spanContext(),
            s = this._idGenerator.generateSpanId();
        let o, a, c;
        i && Vs.isSpanContextValid(i)
            ? ((a = i.traceId), (c = i.traceState), (o = i))
            : (a = this._idGenerator.generateTraceId());
        const u = e.kind ?? ws.INTERNAL,
            l = (e.links ?? []).map((t) => ({ context: t.context, attributes: fo(t.attributes) })),
            d = fo(e.attributes),
        ...
        const p = {
            traceId: a,
            spanId: s,
            traceFlags: h.decision === bs.RECORD_AND_SAMPLED ? qi.SAMPLED : qi.NONE,
            traceState: c,
        };
        if (h.decision === bs.NOT_RECORD) {
            ks.debug("Recording is off, propagating context in a non-recording span");
            return Vs.wrapSpanContext(p);
        }
        const m = fo(Object.assign(d, h.attributes));
        return new Qo({
    ...
    startActiveSpan(t, e, n, r) {
        ...
        2 === arguments.length ? (o = e) : 3 === arguments.length ? ((i = e), (o = n)) : ((i = e), (s = n), (o = r));
        const a = s ?? Os.active(),
            c = this.startSpan(t, i, a),
            u = Vs.setSpan(a, c);
        return Os.with(u, o, void 0, c);
    }
    getGeneralLimits() {
    ...
    forceFlush() {
        ...
        return new Promise((e) => {
            Promise.all(t)
                ...
                .catch((t) => {
                    yo(t || new Error("MultiSpanProcessor: forceFlush failed")), e();
                });
        });
    }
    onStart(t, e) {
...
var fa, ga;
((ga = fa || (fa = {}))[(ga.resolved = 0)] = "resolved"),
    (ga[(ga.timeout = 1)] = "timeout"),
    (ga[(ga.error = 2)] = "error"),
    (ga[(ga.unresolved = 3)] = "unresolved");
class _a {
    _config;
    _tracers = new Map();
    _resource;
    ...
    constructor(t = {}) {
        const e = (function (...t) {
            let e = t.shift();
            const n = new WeakMap();
            for (; t.length > 0; ) e = Vo(e, t.shift(), 0, n);
            return e;
        })(
            {},
            ia(),
        ...
        (this._resource = e.resource ?? lo()), (this._config = Object.assign({}, e, { resource: this._resource }));
        const n = [];
        t.spanProcessors?.length && n.push(...t.spanProcessors), (this._activeSpanProcessor = new ma(n));
    }
    getTracer(t, e, n) {
    ...
    forceFlush() {
            ...
            e = this._activeSpanProcessor._spanProcessors.map(
                (e) =>
                    new Promise((n) => {
                        ...
                        e.forceFlush()
                            .then(() => {
                                clearTimeout(i), r !== fa.timeout && ((r = fa.resolved), n(r));
                            })
                            .catch((t) => {
                                clearTimeout(i), (r = fa.error), n(t);
                            });
                    })
            );
        return new Promise((t, n) => {
            Promise.all(e)
                .then((e) => {
                    const r = e.filter((t) => t !== fa.resolved);
                    r.length > 0 ? n(r) : t();
                })
                .catch((t) => n([t]));
        });
...
class va {
    ...
    disable() {
        return (this._currentContext = Ti), (this._enabled = !1), this;
    }
    enable() {
        return this._enabled || ((this._enabled = !0), (this._currentContext = Ti)), this;
    }
    with(t, e, n, ...r) {
        const i = this._currentContext;
        this._currentContext = t || Ti;
        try {
            return e.call(n, ...r);
        } finally {
...
const ba = Si("OpenTelemetry SDK Context Key SUPPRESS_TRACING");
function ya(t) {
    return !0 === t.getValue(ba);
}
const wa = "baggage";
function Sa(t) {
    const e = t.split(";");
    ...
    return (
        e.length > 0 &&
            ("string" != typeof (a = e.join(";")) &&
                (yi.error("Cannot create baggage metadata from unknown type: " + typeof a), (a = "")),
            (o = {
                __TYPE__: bi,
                toString: function () {
                    return a;
...
class xa {
    ...
    extract(t, e, n) {
        ...
        return (
            ...
            0 === Object.entries(s).length ? t : Gs.setBaggage(t, Gs.createBaggage(s))
        );
    }
    fields() {
        return [wa];
    ...
    inject(t, e, n) {
        for (const i of this._propagators)
            try {
                ...
                ks.warn(`Failed to inject with ${i.constructor.name}. Err: ${r.message}`);
            }
    }
    extract(t, e, n) {
        return this._propagators.reduce((t, r) => {
            try {
                ...
                ks.warn(`Failed to extract with ${r.constructor.name}. Err: ${i.message}`);
            }
            return t;
        }, t);
    }
...
const Ta = "[_0-9a-z-*/]",
    Aa = new RegExp(`^(?:${`[a-z]${Ta}{0,255}`}|${`[a-z0-9]${Ta}{0,240}@[a-z]${Ta}{0,13}`})$`),
    Ca = /^[ -~]{0,255}[!-~]$/,
    Pa = /,|=/;
class Oa {
...
class Ra {
    inject(t, e, n) {
        const r = Vs.getSpanContext(t);
        if (!r || ya(t) || !fs(r)) return;
        const i = `00-${r.traceId}-${r.spanId}-0${Number(r.traceFlags || qi.NONE).toString(16)}`;
        n.set(e, ka, i), r.traceState && n.set(e, La, r.traceState.serialize());
    }
    extract(t, e, n) {
        const r = n.get(e, ka);
        if (!r) return t;
        ...
        if (o) {
            ...
            s.traceState = new Oa("string" == typeof t ? t : void 0);
        }
        return Vs.setSpanContext(t, s);
    }
    fields() {
        return [ka, La];
    }
...
class Na extends _a {
    ...
    register(t = {}) {
        var e;
        Vs.setGlobalTracerProvider(this),
            null !== (e = t.propagator) &&
                (void 0 !== e
                    ? Gs.setGlobalPropagator(e)
                    : Gs.setGlobalPropagator(new Ea({ propagators: [new Ra(), new xa()] }))),
            (function (t) {
                if (null !== t) {
                    if (void 0 === t) {
                        const t = new va();
                        return t.enable(), void Os.setGlobalContextManager(t);
                    }
                    t.enable(), Os.setGlobalContextManager(t);
                }
            })(t.contextManager);
    }
}
const Ia = "exception.message",
    Da = "exception.stacktrace",
    Ua = "exception.type",
    $a = "service.name",
    ja = "service.version",
    Ba = "user_agent.original",
    Fa = "browser.platform",
    Ga = "browser.brands",
    za = "browser.mobile",
    Va = "browser.language",
    Ha = "browser.user_agent";
const Wa = new (class {
        detect(t) {
            if (!("undefined" != typeof navigator)) return uo();
            const e = (function () {
                const t = {},
                    e = navigator.userAgentData;
                e
                    ? ((t[Fa] = e.platform),
                      (t[Ga] = e.brands.map((t) => `${t.brand} ${t.version}`)),
                      (t[za] = e.mobile))
                    : (t[Ha] = navigator.userAgent);
                return (t[Va] = navigator.language), t;
            })();
        ...
        _getResourceAttributes(t, e) {
            return t[Ha] || t[Fa]
                ? { attributes: t }
                : (ks.debug("BrowserDetector failed: Unable to find required browser resources. "), uo());
        }
    })(),
    qa = Si("OpenTelemetry SDK Context Key SUPPRESS_TRACING");
function Ka(t) {
    return (
        null == t ||
        (Array.isArray(t)
...
const Qa = performance;
const Za = Math.pow(10, 6),
    tc = Math.pow(10, 9);
function ec(t) {
    const e = t / 1e3;
    return [Math.trunc(e), Math.round((t % 1e3) * Za)];
}
function nc() {
    let t = Qa.timeOrigin;
    if ("number" != typeof t) {
...
function rc(t) {
    return (function (t, e) {
        ...
        n[1] >= tc && ((n[1] -= tc), (n[0] += 1));
        return n;
    })(ec(nc()), ec("number" == typeof t ? t : Qa.now()));
}
function ic(t) {
    if (((e = t), Array.isArray(e) && 2 === e.length && "number" == typeof e[0] && "number" == typeof e[1])) return t;
    if ("number" == typeof t) return t < nc() ? rc(t) : ec(t);
    if (t instanceof Date) return ec(t.getTime());
...
const ac = "[object Null]",
    cc = "[object Undefined]",
    uc = Function.prototype.toString,
    lc = uc.call(Object),
    dc = Object.getPrototypeOf,
    hc = Object.prototype,
    pc = hc.hasOwnProperty,
    mc = Symbol ? Symbol.toStringTag : void 0,
    fc = hc.toString;
function gc(t) {
    if (
        !(function (t) {
        ...
        "[object Object]" !==
            (function (t) {
                if (null == t) return void 0 === t ? cc : ac;
                return mc && mc in Object(t)
                    ? (function (t) {
                          const e = pc.call(t, mc),
                              n = t[mc];
                          let r = !1;
                          try {
                              (t[mc] = void 0), (r = !0);
    ...
    const e = dc(t);
    if (null === e) return !0;
    const n = pc.call(e, "constructor") && e.constructor;
    return "function" == typeof n && n instanceof n && uc.call(n) === lc;
}
function _c(t) {
    return yc(t) ? t.slice() : t;
}
function vc(t, e, n = 0, r) {
    let i;
    if (!(n > 20)) {
        if ((n++, xc(t) || xc(e) || wc(e))) i = _c(e);
        else if (yc(t)) {
            if (((i = t.slice()), yc(e))) for (let t = 0, n = e.length; t < n; t++) i.push(_c(e[t]));
            else if (Sc(e)) {
                const t = Object.keys(e);
                for (let n = 0, r = t.length; n < r; n++) {
                    const r = t[n];
            ...
            if (Sc(e)) {
                ...
                for (let o = 0, a = s.length; o < a; o++) {
                    const a = s[o],
                        c = e[a];
                    if (xc(c)) void 0 === c ? delete i[a] : (i[a] = c);
                    else {
                        const s = i[a],
                            o = c;
                        if (bc(t, a, r) || bc(e, a, r)) delete i[a];
                        else {
                            if (Sc(s) && Sc(o)) {
                                const n = r.get(s) || [],
                                    i = r.get(o) || [];
...
function Sc(t) {
    return !xc(t) && !yc(t) && !wc(t) && "object" == typeof t;
}
function xc(t) {
    return (
        "string" == typeof t ||
...
const Cc = {
        _export: function (t, e) {
            return new Promise((n) => {
                Os.with(Os.active().setValue(qa, !0), () => {
                    t.export(e, (t) => {
                        n(t);
                    });
                });
...
var Lc,
    Mc = (function () {
        ...
        function r(n) {
            n && n.logger && (t(n.logger) ? (e = n.logger) : e("new logger isn't a function, not replacing"));
        }
        function i(r, i, s) {
            if (r && r[i]) {
                    ...
                    (e.noConflict = function () {
                        ...
                        (e.computeStackTrace = (function () {
                            ...
                            function g(t, n) {
                                ...
                                return (
                                    f(b, t.sourceURL || t.fileName, t.line || t.lineNumber, t.message || t.description),
                                    b
                                );
                            }
                            function _(e, n) {
                                                ...
                                                if ((i = a.exec(n[_])))
                                                    ...
                                                    if (y) {
                                                        ...
                                                        if (w) {
                                                            var S = (w = w.join("\n")).indexOf(y.innerText);
                                                            S >= 0 &&
                                                                (v.line = b + w.substring(0, S).split("\n").length);
                                                        }
                                                    }
                        ...
                        Nc.exports && t.module !== Nc ? (Nc.exports = e) : (t.TraceKit = e);
                }
                function o(t, e) {
...
function Fc(t, e, n) {
    return {
        timeoutMillis: jc(t.timeoutMillis ?? e.timeoutMillis ?? n.timeoutMillis),
...
function zc(t) {
    return new Gc(t.concurrencyLimit);
}
function Vc() {
    return {
        handleResponse(t) {
            null != t &&
                ...
                ks.warn("Received Partial Success response:", JSON.stringify(t.partialSuccess));
        },
    };
}
!(function (t) {
...
class Hc {
    ...
    constructor(t, e, n, r, i) {
        (this._transport = t),
            ...
            (this._timeout = i),
            (this._diagLogger = ks.createComponentLogger({ namespace: "OTLPExportDelegate" }));
    }
    export(t, e) {
        if ((this._diagLogger.debug("items to be sent", t), this._promiseQueue.hasReachedLimit()))
            return void e({ code: Ic.FAILED, error: new Error("Concurrent export limit reached") });
        ...
        null != n
            ? this._promiseQueue.pushPromise(
                  this._transport.send(n, this._timeout).then(
                      (t) => {
                          if ("success" !== t.status)
                              "failure" === t.status && t.error
                                  ? e({ code: Ic.FAILED, error: t.error })
                                  : "retryable" === t.status
                                    ? e({ code: Ic.FAILED, error: new $c("Export failed with retryable status") })
                                    : e({ code: Ic.FAILED, error: new $c("Export failed with unknown error") });
                          else {
                              if (null != t.data)
                                  try {
                      ...
                      (t) => e({ code: Ic.FAILED, error: t })
                  )
              )
            : e({ code: Ic.FAILED, error: new Error("Nothing to send") });
    }
    forceFlush() {
...
function Wc(t, e, n) {
    return (
        (r = { transport: n, serializer: e, promiseHandler: zc(t) }),
        (i = { timeout: t.timeoutMillis }),
        new Hc(r.transport, r.serializer, Vc(), r.promiseHandler, i.timeout)
    );
    var r, i;
}
const qc = Math.pow(10, 9);
function Kc(t) {
...
function Xc(t) {
    ...
    for (let r = 0; r < t.length; r += 2) {
        const i = Kc(t.charCodeAt(r)),
            s = Kc(t.charCodeAt(r + 1));
        e[n++] = (i << 4) | s;
    }
    return e;
}
...
function Jc(t) {
    const e = Yc(t);
    return (n = e), { low: Number(BigInt.asUintN(32, n)), high: Number(BigInt.asUintN(32, n >> BigInt(32))) };
    var n;
}
const Qc =
...
function tu(t) {
    if (void 0 !== t) return Xc(t);
}
const eu = { encodeHrTime: Jc, encodeSpanContext: Xc, encodeOptionalSpanContext: tu };
function nu(t) {
    if (void 0 === t) return eu;
    const e = t.useLongBits ?? !0,
        n = t.useHex ?? !1;
    return { encodeHrTime: e ? Jc : Qc, encodeSpanContext: n ? Zc : Xc, encodeOptionalSpanContext: n ? Zc : tu };
}
function ru(t) {
    return { attributes: su(t.attributes), droppedAttributesCount: 0 };
}
function iu(t) {
    return { name: t.name, version: t.version };
}
function su(t) {
    return Object.keys(t).map((e) => ou(e, t[e]));
}
function ou(t, e) {
    return { key: t, value: au(e) };
}
function au(t) {
    const e = typeof t;
    return "string" === e
        ...
        : "number" === e
          ...
          : "boolean" === e
            ...
            : t instanceof Uint8Array
              ? { bytesValue: t }
              : Array.isArray(t)
                ? { arrayValue: { values: t.map(au) } }
                : "object" === e && null != t
                  ? { kvlistValue: { values: Object.entries(t).map(([t, e]) => ou(t, e)) } }
                  : {};
}
function cu(t, e) {
    const n = (function (t) {
    ...
    return Array.from(n, ([t, n]) => ({
        ...
        scopeLogs: Array.from(n, ([, t]) => ({
            scope: iu(t[0].instrumentationScope),
            logRecords: t.map((t) =>
                (function (t, e) {
                    return {
...
var lu, du, hu, pu, mu, fu, gu, _u, vu, bu;
function yu(t, e) {
    return Array.from(
        t.map((t) => ({
            scope: iu(t.scope),
                ...
                (function (t, e) {
                    const n = {
                        ...
                        r = (function (t) {
                            switch (t) {
                                case lu.DELTA:
                                    return vu.AGGREGATION_TEMPORALITY_DELTA;
                                case lu.CUMULATIVE:
                                    return vu.AGGREGATION_TEMPORALITY_CUMULATIVE;
                            }
                        })(t.aggregationTemporality);
                    switch (t.dataPointType) {
                        case mu.SUM:
                            n.sum = { aggregationTemporality: r, isMonotonic: t.isMonotonic, dataPoints: wu(t, e) };
                            break;
                        case mu.GAUGE:
                            n.gauge = { dataPoints: wu(t, e) };
                            break;
                        case mu.HISTOGRAM:
                            n.histogram = { aggregationTemporality: r, dataPoints: Su(t, e) };
                            break;
                        case mu.EXPONENTIAL_HISTOGRAM:
                            n.exponentialHistogram = { aggregationTemporality: r, dataPoints: xu(t, e) };
                    }
                    return n;
                })(t, e)
            ),
...
function Eu(t, e) {
    return {
        resourceMetrics: t.map((t) =>
            (function (t, e) {
                const n = nu(e);
                return { resource: ru(t.resource), schemaUrl: void 0, scopeMetrics: yu(t.scopeMetrics, n) };
            })(t, e)
        ),
    };
}
function Tu(t, e) {
    ...
    return {
        ...
        events: t.events.map((t) =>
            (function (t, e) {
                return {
                    attributes: t.attributes ? su(t.attributes) : [],
                    name: t.name,
...
function Au(t, e) {
    ...
    for (; !s.done; ) {
        ...
        const u = { resource: ru(t), scopeSpans: o, schemaUrl: void 0 };
        r.push(u), (s = i.next());
    }
    return r;
}
((du = lu || (lu = {}))[(du.DELTA = 0)] = "DELTA"),
    (du[(du.CUMULATIVE = 1)] = "CUMULATIVE"),
    ((pu = hu || (hu = {})).COUNTER = "COUNTER"),
    (pu.GAUGE = "GAUGE"),
    (pu.HISTOGRAM = "HISTOGRAM"),
    (pu.UP_DOWN_COUNTER = "UP_DOWN_COUNTER"),
    (pu.OBSERVABLE_COUNTER = "OBSERVABLE_COUNTER"),
    (pu.OBSERVABLE_GAUGE = "OBSERVABLE_GAUGE"),
    (pu.OBSERVABLE_UP_DOWN_COUNTER = "OBSERVABLE_UP_DOWN_COUNTER"),
    ((fu = mu || (mu = {}))[(fu.HISTOGRAM = 0)] = "HISTOGRAM"),
    (fu[(fu.EXPONENTIAL_HISTOGRAM = 1)] = "EXPONENTIAL_HISTOGRAM"),
    (fu[(fu.GAUGE = 2)] = "GAUGE"),
    (fu[(fu.SUM = 3)] = "SUM"),
    ((_u = gu || (gu = {}))[(_u.DEFAULT = 0)] = "DEFAULT"),
    (_u[(_u.DROP = 1)] = "DROP"),
    (_u[(_u.SUM = 2)] = "SUM"),
    (_u[(_u.LAST_VALUE = 3)] = "LAST_VALUE"),
    (_u[(_u.EXPLICIT_BUCKET_HISTOGRAM = 4)] = "EXPLICIT_BUCKET_HISTOGRAM"),
    (_u[(_u.EXPONENTIAL_HISTOGRAM = 5)] = "EXPONENTIAL_HISTOGRAM"),
    ((bu = vu || (vu = {}))[(bu.AGGREGATION_TEMPORALITY_UNSPECIFIED = 0)] = "AGGREGATION_TEMPORALITY_UNSPECIFIED"),
    (bu[(bu.AGGREGATION_TEMPORALITY_DELTA = 1)] = "AGGREGATION_TEMPORALITY_DELTA"),
    (bu[(bu.AGGREGATION_TEMPORALITY_CUMULATIVE = 2)] = "AGGREGATION_TEMPORALITY_CUMULATIVE");
const Cu = {
        serializeRequest: (t) => {
            const e = { resourceLogs: cu(t, nu({ useHex: !0, useLongBits: !1 })) };
    ...
    Ou = {
        serializeRequest: (t) => {
            const e = { resourceSpans: Au(t, nu({ useHex: !0, useLongBits: !1 })) };
            return new TextEncoder().encode(JSON.stringify(e));
        },
        deserializeResponse: (t) => {
            if (0 === t.length) return {};
...
class Lu {
    ...
    async send(t, e) {
        ...
        for (; "retryable" === r.status && i > 0; ) {
            i--;
            const e = Math.max(Math.min(s, 5e3) + ku(), 0);
            s *= 1.5;
            ...
            Object.entries(i).forEach(([t, e]) => {
                ...
                (r.onreadystatechange = () => {
                    ...
                    r.status >= 200 && r.status <= 299
                        ? (ks.debug("XHR success"), n({ status: "success" }))
                        : r.status && ((t = r.status), [429, 502, 503, 504].includes(t))
                          ? n({ status: "retryable", retryInMillis: Ru(r.getResponseHeader("Retry-After")) })
                          : 0 !== r.status &&
                            n({ status: "failure", error: new Error("XHR request failed with non-retryable status") });
                }),
                (r.onabort = () => {
    ...
    send(t) {
        return new Promise((e) => {
            navigator.sendBeacon(this._params.url, new Blob([t], { type: this._params.blobType }))
                ? (ks.debug("SendBeacon success"), e({ status: "success" }))
...
function Du(t, e, n) {
    const r = { ...n() },
        i = {};
    return () => (null != e && Object.assign(i, e()), null != t && Object.assign(i, t()), Object.assign(i, r));
}
function Uu(t) {
    if (null != t)
        try {
                ...
                () => {
                    ...
                    return (
                        Object.entries(o?.() ?? {}).forEach(([e, n]) => {
                            void 0 !== n
                                ? (t[e] = String(n))
                                : ks.warn(`Header "${e}" has invalid value (${n}) and will be ignored`);
                        }),
                        t
                    );
                }),
...
function ju(t, e, n, r) {
    ...
    return i
        ? (function (t, e) {
              return Wc(t, e, Mu({ transport: ((n = t), new Nu(n)) }));
              var n;
          })(s, e)
        : (function (t, e) {
              return Wc(
                  t,
                  e,
                  Mu({ transport: ((n = { url: t.url, blobType: t.headers()["Content-Type"] }), new Iu(n)) })
              );
              var n;
          })(s, e);
}
class Bu extends Uc {
    constructor(t = {}) {
        super(ju(t, Ou, "v1/traces", { "Content-Type": "application/json" }));
    }
}
var Fu, Gu;
((Gu = Fu || (Fu = {}))[(Gu.DELTA = 0)] = "DELTA"),
    (Gu[(Gu.CUMULATIVE = 1)] = "CUMULATIVE"),
    (Gu[(Gu.LOWMEMORY = 2)] = "LOWMEMORY");
const zu = () => lu.CUMULATIVE,
    Vu = (t) => {
        switch (t) {
            case hu.COUNTER:
            case hu.OBSERVABLE_COUNTER:
            case hu.GAUGE:
            case hu.HISTOGRAM:
            case hu.OBSERVABLE_GAUGE:
                return lu.DELTA;
            case hu.UP_DOWN_COUNTER:
            case hu.OBSERVABLE_UP_DOWN_COUNTER:
                return lu.CUMULATIVE;
        }
    },
    Hu = (t) => {
        switch (t) {
...
const qu = Object.freeze({ type: gu.DEFAULT });
class Ku extends Uc {
    ...
    constructor(t, e) {
        super(t),
            (this._aggregationSelector = (function (t) {
                return t?.aggregationPreference ?? (() => qu);
            })(e)),
            (this._aggregationTemporalitySelector = Wu(e?.temporalityPreference));
    }
    selectAggregation(t) {
...
class Xu extends Ku {
    constructor(t) {
        super(ju(t ?? {}, Pu, "v1/metrics", { "Content-Type": "application/json" }), t);
    }
}
class Yu extends Uc {
    constructor(t = {}) {
        super(ju(t, Cu, "v1/logs", { "Content-Type": "application/json" }));
    }
}
class Ju {
    _sessionIdProvider;
...
var el =
    (Qu ||
        ...
        (function (t, e) {
            ...
            })("object" == typeof window ? window : tl);
        })(Zu, Zu.exports)),
    Zu.exports);
const nl = e(el);
var rl, il, sl, ol, al;
...
class ll extends Error {
    constructor(t) {
        super(t), Object.setPrototypeOf(this, ll.prototype);
    }
}
function dl(t, e) {
    let n;
...
((al = ol || (ol = {}))[(al.DROP = 0)] = "DROP"),
    (al[(al.SUM = 1)] = "SUM"),
    (al[(al.LAST_VALUE = 2)] = "LAST_VALUE"),
    (al[(al.HISTOGRAM = 3)] = "HISTOGRAM"),
    (al[(al.EXPONENTIAL_HISTOGRAM = 4)] = "EXPONENTIAL_HISTOGRAM");
class ml {
    kind = ol.DROP;
    createAccumulation() {}
    merge(t, e) {}
...
class gl {
    ...
    createAccumulation(t) {
        return new fl(t, this._boundaries, this._recordMinMax);
    }
    merge(t, e) {
        ...
        return (
            ...
            new fl(t.startTime, n.buckets.boundaries, this._recordMinMax, {
    ...
    diff(t, e) {
        ...
        return new fl(e.startTime, n.buckets.boundaries, this._recordMinMax, {
            buckets: { boundaries: n.buckets.boundaries, counts: o },
    ...
    toMetricData(t, e, n, r) {
        return {
            ...
            dataPointType: sl.HISTOGRAM,
            dataPoints: n.map(([e, n]) => {
                const i = n.toPointValue(),
                    s =
                        t.type === il.GAUGE ||
                        t.type === il.UP_DOWN_COUNTER ||
                        t.type === il.OBSERVABLE_GAUGE ||
                        t.type === il.OBSERVABLE_UP_DOWN_COUNTER;
                return {
                    attributes: e,
...
class _l {
    ...
    indexStart;
    indexEnd;
    constructor(t = new vl(), e = 0, n = 0, r = 0) {
    ...
    clone() {
        return new _l(this.backing.clone(), this.indexBase, this.indexStart, this.indexEnd);
    }
    _rotate() {
        ...
        0 !== t &&
            (t > 0
                ...
                : (this.backing.reverse(0, this.backing.length), this.backing.reverse(0, this.backing.length + t)),
...
function Sl(t) {
    ...
    e.setFloat64(0, t);
    return ((2146435072 & e.getUint32(0)) >> 20) - bl;
}
function xl(t) {
    const e = new DataView(new ArrayBuffer(8));
    e.setFloat64(0, t);
...
function El(t, e) {
    return 0 === t || t === Number.POSITIVE_INFINITY || t === Number.NEGATIVE_INFINITY || Number.isNaN(t)
        ? t
        : t * Math.pow(2, e);
}
...
class Al {
    ...
    mapToIndex(t) {
        if (t < wl) return this._minNormalLowerBoundaryIndex();
        return (Sl(t) + this._rightShift(xl(t) - 1, 52)) >> this._shift;
    }
    lowerBoundary(t) {
        const e = this._minNormalLowerBoundaryIndex();
        if (t < e) throw new Tl(`underflow: ${t} is < minimum lower boundary: ${e}`);
        const n = this._maxNormalLowerBoundaryIndex();
        if (t > n) throw new Tl(`overflow: ${t} is > maximum lower boundary: ${n}`);
        return El(1, t << this._shift);
    }
    get scale() {
...
class Cl {
    ...
    _inverseFactor;
    constructor(t) {
        (this._scale = t), (this._scaleFactor = El(Math.LOG2E, t)), (this._inverseFactor = El(Math.LN2, -t));
    }
    mapToIndex(t) {
        if (t <= wl) return this._minNormalLowerBoundaryIndex() - 1;
        if (0 === xl(t)) {
            return (Sl(t) << this._scale) - 1;
        }
    ...
    lowerBoundary(t) {
        ...
        if (t >= e) {
            ...
            throw new Tl(`overflow: ${t} is > maximum lower boundary: ${e}`);
        }
        const n = this._minNormalLowerBoundaryIndex();
        if (t <= n) {
            if (t === n) return wl;
            if (t === n - 1) return Math.exp((t + (1 << this._scale)) / this._scaleFactor) / 2;
            throw new Tl(`overflow: ${t} is < minimum lower boundary: ${n}`);
        }
...
const Pl = Array.from({ length: 31 }, (t, e) => (e > 10 ? new Cl(e - 10) : new Al(e - 10)));
function Ol(t) {
    if (t > 20 || t < -10) throw new Tl(`expected scale >= -10 && <= 20, got: ${t}`);
    return Pl[t + 10];
}
class kl {
    low;
    high;
    static combine(t, e) {
        return new kl(Math.min(t.low, e.low), Math.max(t.high, e.high));
    }
    constructor(t, e) {
...
class Ll {
    ...
    updateByIncrement(t, e) {
        Number.isNaN(t) ||
            ...
            0 !== t
                ? ((this._sum += t * e),
                  t > 0 ? this._updateBuckets(this._positive, t, e) : this._updateBuckets(this._negative, -t, e))
                : (this._zeroCount += e));
    }
    merge(t) {
        0 === this._count
            ? ((this._min = t.min), (this._max = t.max))
            : 0 !== t.count && (t.min < this.min && (this._min = t.min), t.max > this.max && (this._max = t.max)),
        ...
        if (
            (0 === t.length
                ...
                : r < t.indexStart && t.indexEnd - r >= this._maxSize
                  ...
                  : r > t.indexEnd && r - t.indexStart >= this._maxSize && ((i = !0), (o = t.indexStart), (s = r)),
            i)
        ) {
    ...
    _grow(t, e) {
        const n = t.backing.length,
            ...
            i = n - r;
        let s = ((o = e), o--, (o |= o >> 1), (o |= o >> 2), (o |= o >> 4), (o |= o >> 8), (o |= o >> 16), ++o);
        var o;
    ...
    _downscale(t) {
        ...
        this._positive.downscale(t), this._negative.downscale(t), (this._mapping = Ol(e));
    }
    _minScale(t) {
    ...
    _highLowAtScale(t, e, n) {
        if (0 === t.length) return new kl(0, -1);
        const r = e - n;
        return new kl(t.indexStart >> r, t.indexEnd >> r);
    }
...
class Ml {
    _maxSize;
    _recordMinMax;
    kind = ol.EXPONENTIAL_HISTOGRAM;
    constructor(t, e) {
        (this._maxSize = t), (this._recordMinMax = e);
    }
    createAccumulation(t) {
        return new Ll(t, this._maxSize, this._recordMinMax);
    }
    merge(t, e) {
        const n = e.clone();
        return n.merge(t), n;
    ...
    toMetricData(t, e, n, r) {
        return {
            descriptor: t,
            aggregationTemporality: e,
            dataPointType: sl.EXPONENTIAL_HISTOGRAM,
            dataPoints: n.map(([e, n]) => {
                const i = n.toPointValue(),
                    s =
                        t.type === il.GAUGE ||
...
class Rl {
    ...
    record(t) {
        (this._current = t), (this.sampleTime = ec(Date.now()));
    }
    setStartTime(t) {
        this.startTime = t;
    }
...
class Nl {
    ...
    merge(t, e) {
        const n = sc(e.sampleTime) >= sc(t.sampleTime) ? e : t;
        return new Rl(t.startTime, n.toPointValue(), n.sampleTime);
    }
    diff(t, e) {
        const n = sc(e.sampleTime) >= sc(t.sampleTime) ? e : t;
        return new Rl(e.startTime, n.toPointValue(), n.sampleTime);
    }
    toMetricData(t, e, n, r) {
        return {
            descriptor: t,
            aggregationTemporality: e,
            dataPointType: sl.GAUGE,
...
class Dl {
    ...
    createAccumulation(t) {
        return new Il(t, this.monotonic);
    }
    merge(t, e) {
        const n = t.toPointValue(),
            r = e.toPointValue();
        return e.reset ? new Il(e.startTime, this.monotonic, r, e.reset) : new Il(t.startTime, this.monotonic, n + r);
    }
    diff(t, e) {
        const n = t.toPointValue(),
            r = e.toPointValue();
        return this.monotonic && n > r
            ? new Il(e.startTime, this.monotonic, r, !0)
            : new Il(e.startTime, this.monotonic, r - n);
    }
    toMetricData(t, e, n, r) {
        return {
            descriptor: t,
            aggregationTemporality: e,
            dataPointType: sl.SUM,
            dataPoints: n.map(([t, e]) => ({
                attributes: t,
                startTime: e.startTime,
                endTime: r,
...
class Ul {
    static DEFAULT_INSTANCE = new ml();
    createAggregator(t) {
        return Ul.DEFAULT_INSTANCE;
    }
}
class $l {
    static MONOTONIC_INSTANCE = new Dl(!0);
    static NON_MONOTONIC_INSTANCE = new Dl(!1);
    createAggregator(t) {
        switch (t.type) {
            case il.COUNTER:
            case il.OBSERVABLE_COUNTER:
            case il.HISTOGRAM:
                return $l.MONOTONIC_INSTANCE;
            default:
                return $l.NON_MONOTONIC_INSTANCE;
        }
    }
}
class jl {
    static DEFAULT_INSTANCE = new Nl();
    createAggregator(t) {
        return jl.DEFAULT_INSTANCE;
    }
}
class Bl {
    static DEFAULT_INSTANCE = new gl([0, 5, 10, 25, 50, 75, 100, 250, 500, 750, 1e3, 2500, 5e3, 7500, 1e4], !0);
    createAggregator(t) {
        return Bl.DEFAULT_INSTANCE;
    }
}
class Fl {
    _recordMinMax;
    ...
    createAggregator(t) {
        return new gl(this._boundaries, this._recordMinMax);
    }
}
class Gl {
    _maxSize;
    ...
    createAggregator(t) {
        return new Ml(this._maxSize, this._recordMinMax);
    }
}
const zl = new Ul(),
    Vl = new $l(),
    ...
    ql = new (class {
        _resolve(t) {
            switch (t.type) {
                case il.COUNTER:
                case il.UP_DOWN_COUNTER:
                case il.OBSERVABLE_COUNTER:
                case il.OBSERVABLE_UP_DOWN_COUNTER:
                    return Vl;
                case il.GAUGE:
                case il.OBSERVABLE_GAUGE:
                    return Hl;
                case il.HISTOGRAM:
                    return t.advice.explicitBucketBoundaries ? new Fl(t.advice.explicitBucketBoundaries) : Wl;
            }
            return ks.warn(`Unable to recognize instrument type: ${t.type}`), zl;
        }
        createAggregator(t) {
...
function Xl(t) {
    switch (t.type) {
        ...
        case Kl.LAST_VALUE:
            return Hl;
        case Kl.EXPONENTIAL_HISTOGRAM: {
            const e = t;
            return new Gl(e.options?.maxSize, e.options?.recordMinMax);
        }
        case Kl.EXPLICIT_BUCKET_HISTOGRAM: {
            const e = t;
            return null == e.options ? Wl : new Fl(e.options?.boundaries, e.options?.recordMinMax);
        }
        default:
...
class Ql {
    ...
    constructor(t) {
        (this._aggregationSelector = t?.aggregationSelector ?? Yl),
            (this._aggregationTemporalitySelector = t?.aggregationTemporalitySelector ?? Jl),
    ...
    onInitialized() {}
    async collect(t) {
        if (void 0 === this._sdkMetricProducer) throw new Error("MetricReader is not bound to a MetricProducer");
        ...
        const [e, ...n] = await Promise.all([
            ...
            r = e.errors.concat(pl(n, (t) => t.errors));
        return {
            resourceMetrics: {
                resource: e.resourceMetrics.resource,
                scopeMetrics: e.resourceMetrics.scopeMetrics.concat(pl(n, (t) => t.resourceMetrics.scopeMetrics)),
            },
            errors: r,
        };
    }
    async shutdown(t) {
        this._shutdown
            ? ks.error("Cannot call shutdown twice.")
            : (null == t?.timeoutMillis ? await this.onShutdown() : await dl(this.onShutdown(), t.timeoutMillis),
              (this._shutdown = !0));
    }
    async forceFlush(t) {
        this._shutdown
            ? ks.warn("Cannot forceFlush on already shutdown MetricReader.")
            : null != t?.timeoutMillis
              ? await dl(this.onForceFlush(), t.timeoutMillis)
...
class Zl extends Ql {
    ...
    async _runOnce() {
        try {
            await dl(this._doRun(), this._exportTimeout);
        } catch (t) {
            if (t instanceof ll)
                return void ks.error("Export took longer than %s milliseconds and timed out.", this._exportTimeout);
            Ja(t);
        }
    }
    async _doRun() {
        const { resourceMetrics: t, errors: e } = await this.collect({ timeoutMillis: this._exportTimeout });
        if (
            (e.length > 0 && ks.error("PeriodicExportingMetricReader: metrics collection errors", ...e),
            t.resource.asyncAttributesPending)
        )
            try {
                await t.resource.waitForAsyncAttributes?.();
            } catch (r) {
                ks.debug("Error while resolving async portion of resource: ", r), Ja(r);
            }
        if (0 === t.scopeMetrics.length) return;
        const n = await Cc._export(this._exporter, t);
        if (n.code !== oc.SUCCESS)
...
class td {
    ...
    constructor(t) {
        this._temporalitySelector = t?.temporalitySelector ?? Jl;
    }
    export(t, e) {
        if (!this._shutdown) return td._sendMetrics(t, e);
        setImmediate(e, { code: oc.FAILED });
    }
    forceFlush() {
        return Promise.resolve();
    }
...
function nd(t, e, n) {
    return (
            ...
            ),
        {
            ...
            unit: n?.unit ?? "",
            valueType: n?.valueType ?? xi.DOUBLE,
            advice: n?.advice ?? {},
        }
    );
}
function rd(t, e) {
    return (
        (n = t.name),
        (r = e.name),
        n.toLowerCase() === r.toLowerCase() && t.unit === e.unit && t.type === e.type && t.valueType === e.valueType
    );
    var n, r;
}
const id = /^[a-z][a-z0-9_.\-/]{0,254}$/i;
class sd {
    ...
    _record(t, e = {}, n = Os.active()) {
        "number" == typeof t
            ? (this._descriptor.valueType !== xi.INT ||
                  Number.isInteger(t) ||
                  (ks.warn(
                  ...
                  (t = Math.trunc(t)),
                  Number.isInteger(t))) &&
              this._writableMetricStorage.record(t, e, n, ec(Date.now()))
            : ks.warn(`non-number value provided to metric ${this._descriptor.name}: ${t}`);
    }
}
class od extends sd {
    add(t, e, n) {
...
class ad extends sd {
    add(t, e, n) {
        t < 0 ? ks.warn(`negative value provided to counter ${this._descriptor.name}: ${t}`) : this._record(t, e, n);
    }
}
class cd extends sd {
    record(t, e, n) {
...
class ud extends sd {
    record(t, e, n) {
        t < 0 ? ks.warn(`negative value provided to histogram ${this._descriptor.name}: ${t}`) : this._record(t, e, n);
    }
}
class ld {
    _observableRegistry;
...
class fd {
    ...
    createGauge(t, e) {
        const n = nd(t, il.GAUGE, e),
            r = this._meterSharedState.registerMetricStorage(n);
        return new cd(r, n);
    }
    createHistogram(t, e) {
        const n = nd(t, il.HISTOGRAM, e),
            r = this._meterSharedState.registerMetricStorage(n);
        return new ud(r, n);
    }
    createCounter(t, e) {
        const n = nd(t, il.COUNTER, e),
            r = this._meterSharedState.registerMetricStorage(n);
        return new ad(r, n);
    }
    createUpDownCounter(t, e) {
        const n = nd(t, il.UP_DOWN_COUNTER, e),
            r = this._meterSharedState.registerMetricStorage(n);
        return new od(r, n);
    }
    createObservableGauge(t, e) {
        const n = nd(t, il.OBSERVABLE_GAUGE, e),
            r = this._meterSharedState.registerAsyncMetricStorage(n);
        return new hd(n, r, this._meterSharedState.observableRegistry);
    }
    createObservableCounter(t, e) {
        const n = nd(t, il.OBSERVABLE_COUNTER, e),
            r = this._meterSharedState.registerAsyncMetricStorage(n);
        return new dd(n, r, this._meterSharedState.observableRegistry);
    }
    createObservableUpDownCounter(t, e) {
        const n = nd(t, il.OBSERVABLE_UP_DOWN_COUNTER, e),
            r = this._meterSharedState.registerAsyncMetricStorage(n);
        return new pd(n, r, this._meterSharedState.observableRegistry);
    }
...
class gd {
    ...
    updateDescription(t) {
        this._instrumentDescriptor = nd(this._instrumentDescriptor.name, this._instrumentDescriptor.type, {
            description: t,
...
class _d {
    ...
    set(t, e, n) {
        (n ??= this._hash(t)), this._keyMap.has(n) || this._keyMap.set(n, t), this._valueMap.set(n, e);
    }
    has(t, e) {
    ...
    *entries() {
        ...
        let e = t.next();
        for (; !0 !== e.done; ) yield [this._keyMap.get(e.value[0]), e.value[1], e.value[0]], (e = t.next());
    }
    get size() {
...
class bd {
    _aggregator;
    _activeCollectionStorage = new vd();
    _cumulativeMemoStorage = new vd();
    _cardinalityLimit;
    ...
    constructor(t, e) {
        (this._aggregator = t),
            ...
            (this._overflowHashCode = ul(this._overflowAttributes));
    }
    record(t, e, n, r) {
    ...
    batchCumulate(t, e) {
        Array.from(t.entries()).forEach(([t, n, r]) => {
            ...
            if (this._cumulativeMemoStorage.has(t, r)) {
                ...
                ((t = this._overflowAttributes), (r = this._overflowHashCode), this._cumulativeMemoStorage.has(t, r))
            ) {
                const e = this._cumulativeMemoStorage.get(t, r);
                s = this._aggregator.diff(e, i);
            }
    ...
    collect() {
        ...
        return (this._activeCollectionStorage = new vd()), t;
    }
}
class yd {
    _aggregator;
    ...
    buildMetrics(t, e, n, r) {
        ...
        if (this._reportHistory.has(t)) {
            ...
            (s = e.aggregationTemporality),
                (o =
                    s === rl.CUMULATIVE
                        ? yd.merge(e.accumulations, i, this._aggregator)
                        : yd.calibrateStartTime(e.accumulations, i, n));
    ...
    _getMergedUnreportedAccumulations(t) {
        ...
        for (const r of n) e = yd.merge(e, r, this._aggregator);
        return e;
    }
    static merge(t, e, n) {
        const r = t,
...
class wd extends gd {
    ...
    constructor(t, e, n, r, i) {
        super(t),
            ...
            (this._deltaMetricStorage = new bd(e, this._aggregationCardinalityLimit)),
            (this._temporalMetricStorage = new yd(e, r));
    }
    record(t, e) {
        const n = new vd();
...
class Ed {
    ...
    registerForCollector(t, e) {
        ...
        null == n && ((n = new Map()), this._perCollectorRegistry.set(t, n)), this._registerStorage(e, n);
    }
...
class Ad {
    ...
    observe(t, e = {}) {
        "number" == typeof t
            ...
            : ks.warn(`non-number value provided to metric ${this._instrumentName}: ${t}`);
    }
}
class Cd {
    _buffer = new Map();
    observe(t, e, n = {}) {
        ...
        null == r && ((r = new vd()), this._buffer.set(t, r)),
            "number" == typeof e
                ? (t._descriptor.valueType !== xi.INT ||
                      Number.isInteger(e) ||
                      (ks.warn(
                      ...
                      Number.isInteger(e))) &&
                  r.set(n, e)
                : ks.warn(`non-number value provided to metric ${t._descriptor.name}: ${e}`);
    }
}
class Pd {
    _callbacks = [];
    ...
    addBatchCallback(t, e) {
        const n = new Set(e.filter(md));
        if (0 === n.size) return void ks.error("BatchObservableCallback is not associated with valid instruments", e);
        this._findBatchCallback(t, n) >= 0 || this._batchCallbacks.push({ callback: t, instruments: n });
    }
    ...
    _observeCallbacks(t, e) {
        return this._callbacks.map(async ({ callback: n, instrument: r }) => {
            const i = new Ad(r._descriptor.name, r._descriptor.valueType);
...
class Rd {
    ...
    metricStorageRegistry = new Ed();
    observableRegistry = new Pd();
    meter;
    constructor(t, e) {
        (this._meterProviderSharedState = t), (this._instrumentationScope = e), (this.meter = new fd(this));
    }
    registerMetricStorage(t) {
        const e = this._registerMetricStorage(t, Od);
        return 1 === e.length ? e[0] : new Td(e);
    }
    registerAsyncMetricStorage(t) {
        return this._registerMetricStorage(t, wd);
    }
    async collect(t, e, n) {
        const r = await this.observableRegistry.observe(e, n?.timeoutMillis),
            i = this.metricStorageRegistry.getStorages(t);
        if (0 === i.length) return null;
        const s = i.map((n) => n.collect(t, e)).filter(cl);
        return 0 === s.length
            ? { errors: r }
...
class Nd {
    ...
    getMeterSharedState(t) {
        ...
        return null == n && ((n = new Rd(this, t)), this.meterSharedStates.set(e, n)), n;
    }
    selectAggregations(t) {
        const e = [];
        for (const n of this.metricCollectors) e.push([n, Xl(n.selectAggregation(t))]);
        return e;
    }
}
class Id {
    ...
    async collect(t) {
        const e = ec(Date.now()),
            ...
            i = Array.from(this._sharedState.meterSharedStates.values()).map(async (i) => {
                ...
                null != s?.scopeMetrics && n.push(s.scopeMetrics), null != s?.errors && r.push(...s.errors);
            });
        return (
            await Promise.all(i),
...
class Ud {
    ...
    constructor(t) {
        "*" === t
            ...
            : ((this._matchAll = !1), (this._regexp = new RegExp(Ud.escapePattern(t))));
    }
    match(t) {
        return !!this._matchAll || this._regexp.test(t);
    }
    static escapePattern(t) {
        return `^${t.replace(Dd, "\\$&").replace("*", ".*")}$`;
    }
...
class jd {
    ...
    _unitFilter;
    constructor(t) {
        (this._nameFilter = new Ud(t?.name ?? "*")), (this._type = t?.type), (this._unitFilter = new $d(t?.unit));
    }
    getType() {
        return this._type;
    }
...
class Bd {
    ...
    _schemaUrlFilter;
    constructor(t) {
        (this._nameFilter = new $d(t?.name)),
            (this._versionFilter = new $d(t?.version)),
            (this._schemaUrlFilter = new $d(t?.schemaUrl));
    }
    getNameFilter() {
        return this._nameFilter;
    }
...
class Fd {
    ...
    constructor(t) {
        ...
        !(function (t) {
            ...
            var e;
            if (null != t.name && (null == t?.instrumentName || Ud.hasWildcard(t.instrumentName)))
                throw new Error(
            ...
            null != t.attributesProcessors
                ? (this.attributesProcessor = ((e = t.attributesProcessors), new kd(e)))
                : (this.attributesProcessor = Ld()),
            (this.name = t.name),
            (this.description = t.description),
            (this.aggregation = Xl(t.aggregation ?? { type: Kl.DEFAULT })),
            (this.instrumentSelector = new jd({
                name: t.instrumentName,
                type: t.instrumentType,
                unit: t.instrumentUnit,
            })),
            (this.meterSelector = new Bd({ name: t.meterName, version: t.meterVersion, schemaUrl: t.meterSchemaUrl })),
...
class Gd {
    ...
    _shutdown = !1;
    constructor(t) {
        if (((this._sharedState = new Nd(t?.resource ?? lo())), null != t?.views && t.views.length > 0))
            for (const e of t.views) this._sharedState.viewRegistry.addView(new Fd(e));
        if (null != t?.readers && t.readers.length > 0)
            for (const e of t.readers) {
                const t = new Id(this._sharedState, e);
                e.setMetricProducer(t), this._sharedState.metricCollectors.push(t);
            }
    }
    getMeter(t, e = "", n = {}) {
        return this._shutdown
            ? (ks.warn("A shutdown MeterProvider cannot provide a Meter"), ji)
            : this._sharedState.getMeterSharedState({ name: t, version: e, schemaUrl: n.schemaUrl }).meter;
    }
    async shutdown(t) {
        this._shutdown
            ? ks.warn("shutdown may only be called once per MeterProvider")
            : ((this._shutdown = !0), await Promise.all(this._sharedState.metricCollectors.map((e) => e.shutdown(t))));
    }
    async forceFlush(t) {
        this._shutdown
            ? ks.warn("invalid attempt to force flush after MeterProvider shutdown")
...
class Wd {
    ...
    _getLogger() {
        if (this._delegate) return this._delegate;
        const t = this._provider.getDelegateLogger(this.name, this.version, this.options);
        return t ? ((this._delegate = t), this._delegate) : Vd;
    }
}
class qd {
    getLogger(t, e, n) {
        var r;
        return null !== (r = this.getDelegateLogger(t, e, n)) && void 0 !== r ? r : new Wd(this, t, e, n);
    }
    getDelegate() {
        var t;
        return null !== (t = this._delegate) && void 0 !== t ? t : Hd;
    }
    setDelegate(t) {
        this._delegate = t;
    }
            ...
            : "object" == typeof self
              ...
              : "object" == typeof window
                ...
                : "object" == typeof global
                  ? global
                  : {},
    Xd = Symbol.for("io.opentelemetry.js.api.logs"),
    Yd = Kd;
class Jd {
    constructor() {
        this._proxyLoggerProvider = new qd();
    }
    static getInstance() {
        return this._instance || (this._instance = new Jd()), this._instance;
    }
    setGlobalLoggerProvider(t) {
        return Yd[Xd]
            ? this.getLoggerProvider()
            : ((Yd[Xd] = ((e = 1), (n = t), (r = Hd), (t) => (t === e ? n : r))),
              this._proxyLoggerProvider.setDelegate(t),
              t);
        var e, n, r;
    }
    getLoggerProvider() {
        var t, e;
        return null !== (e = null === (t = Yd[Xd]) || void 0 === t ? void 0 : t.call(Yd, 1)) && void 0 !== e
            ? e
            : this._proxyLoggerProvider;
    }
    getLogger(t, e, n) {
    ...
    disable() {
        delete Yd[Xd], (this._proxyLoggerProvider = new qd());
    }
}
const Qd = Jd.getInstance();
class Zd {
    hrTime;
    hrTimeObserved;
    spanContext;
    ...
    constructor(t, e, n) {
        const {
            ...
            d = Date.now();
        if (((this.hrTime = ic(r ?? d)), (this.hrTimeObserved = ic(i ?? d)), l)) {
            const t = Vs.getSpanContext(l);
            t && fs(t) && (this.spanContext = t);
        }
    ...
    setAttribute(t, e) {
        return this._isLogRecordReadonly() || null === e
            ? this
            : 0 === t.length
              ? (ks.warn(`Invalid attribute key: ${t}`), this)
              : Ka(e) || ("object" == typeof e && !Array.isArray(e) && Object.keys(e).length > 0)
                ? ((this.totalAttributesCount += 1),
                  Object.keys(this.attributes).length >= this._logRecordLimits.attributeCountLimit &&
                  !Object.prototype.hasOwnProperty.call(this.attributes, t)
                      ? (1 === this.droppedAttributesCount && ks.warn("Dropping extra attributes."), this)
                      : (Ka(e) ? (this.attributes[t] = this._truncateToSize(e)) : (this.attributes[t] = e), this))
                : (ks.warn(`Invalid attribute value set for key: ${t}`), this);
    }
    setAttributes(t) {
        for (const [e, n] of Object.entries(t)) this.setAttribute(e, n);
        return this;
    ...
    _isLogRecordReadonly() {
        return this._isReadonly && ks.warn("Can not execute the operation on emitted log record"), this._isReadonly;
    }
}
class th {
    instrumentationScope;
    ...
    emit(t) {
        const e = t.context || Os.active(),
            n = new Zd(this._sharedState, this.instrumentationScope, { context: e, ...t });
        ...
        (this.resource = t),
            ...
            r.length > 0
                ? ((this.registeredLogRecordProcessors = r),
                  (this.activeProcessor = new nh(this.registeredLogRecordProcessors, this.forceFlushTimeoutMillis)))
                : (this.activeProcessor = new eh());
    }
}
class ih {
    _shutdownOnce;
    ...
    constructor(t = {}) {
        const e = (function (...t) {
                let e = t.shift();
                const n = new WeakMap();
                for (; t.length > 0; ) e = vc(e, t.shift(), 0, n);
                return e;
            })(
                {},
                {
        ...
        (this._sharedState = new rh(
            ...
            (this._shutdownOnce = new Ac(this._shutdown, this));
    }
    getLogger(t, e, n) {
        if (this._shutdownOnce.isCalled) return ks.warn("A shutdown LoggerProvider cannot provide a Logger"), Vd;
        t || ks.warn("Logger requested without instrumentation scope name.");
        const r = t || "unknown",
            i = `${r}@${e || ""}:${n?.schemaUrl || ""}`;
        return (
            this._sharedState.loggers.has(i) ||
                this._sharedState.loggers.set(
                    i,
                    new th({ name: r, version: e, schemaUrl: n?.schemaUrl }, this._sharedState)
                ),
    ...
    forceFlush() {
        return this._shutdownOnce.isCalled
            ? (ks.warn("invalid attempt to force flush after LoggerProvider shutdown"), this._shutdownOnce.promise)
            : this._sharedState.activeProcessor.forceFlush();
    }
    shutdown() {
        return this._shutdownOnce.isCalled
            ? (ks.warn("shutdown may only be called once per LoggerProvider"), this._shutdownOnce.promise)
...
class oh {
    ...
    onEmit(t) {
        ...
        const e = () =>
            Cc._export(this._exporter, [t])
                .then((t) => {
                    t.code !== oc.SUCCESS &&
                        Ja(t.error ?? new Error(`SimpleLogRecordProcessor: log record export failed (status ${t})`));
                })
                .catch(Ja);
        if (t.resource.asyncAttributesPending) {
            const n = t.resource.waitForAsyncAttributes?.().then(() => (this._unresolvedExports.delete(n), e()), Ja);
...
class ah {
    constructor(t = {}) {
        var e, n, r;
        if (
            ((this._resource = lo().merge(null !== (e = t.resource) && void 0 !== e ? e : co({}))),
            (this._resourceDetectors = null !== (n = t.resourceDetectors) && void 0 !== n ? n : [Wa]),
            ...
            t.traceExporter && n.push(new ua(t.traceExporter)),
    ...
    start() {
        ...
        if (this._autoDetectResources) {
            ...
            this._resource = this._resource.merge(po(t));
        }
        (this._resource =
            void 0 === this._serviceName ? this._resource : this._resource.merge(co({ [$a]: this._serviceName }))),
            void 0 !== this._serviceVersion &&
                (this._resource = this._resource.merge(co({ [ja]: this._serviceVersion })));
        const s = [];
        ...
        const o = new Na(
            Object.assign(
                Object.assign({}, null === (n = this._tracerProviderConfig) || void 0 === n ? void 0 : n.tracerConfig),
        ...
        if (
            ...
            o.register({
                contextManager: null === (r = this._tracerProviderConfig) || void 0 === r ? void 0 : r.contextManager,
                propagator: null === (i = this._tracerProviderConfig) || void 0 === i ? void 0 : i.textMapPropagator,
            }),
            this._meterProviderConfig)
        ) {
            const t = this._meterProviderConfig.metricExporters.map((t) => new Zl({ exporter: t }));
            (this._meterProvider = new Gd({ resource: this._resource, readers: t })),
                Rs.setGlobalMeterProvider(this._meterProvider);
        }
        if (this._loggerProviderConfig) {
            const t = this._loggerProviderConfig.logExporters.map((t) => new oh(t));
            (this._loggerProvider = new ih({ resource: this._resource, processors: t })),
                Qd.setGlobalLoggerProvider(this._loggerProvider);
        }
        !(function (t) {
            const e = t.tracerProvider || Vs.getTracerProvider(),
                n = t.meterProvider || Rs.getMeterProvider(),
                r = t.loggerProvider || Zs.getLoggerProvider(),
...
const ch = "https://api.honeycomb.io",
    uh = "v1/traces",
    lh = `${ch}/${uh}`,
    dh = "v1/metrics",
    hh = `${ch}/${dh}`,
    ...
    gh = (t) => `@honeycombio/opentelemetry-web: ${t}`,
    _h = /^[a-f0-9]*$/,
    vh = /^hc[a-z]ic_[a-z0-9]*$/;
function bh(t) {
    return null != t && 0 !== t.length && (32 === t.length ? _h.test(t) : 64 === t.length && vh.test(t));
}
function yh(t, e) {
    ...
    xh = (t) =>
        (null == t ? void 0 : t.logsEndpoint)
            ...
            : (null == t ? void 0 : t.endpoint)
              ? yh(t.endpoint, ph)
              : mh,
    Eh = (t) => (null == t ? void 0 : t.tracesApiKey) || (null == t ? void 0 : t.apiKey),
    Th = (t) =>
        ...
        (null == t ? void 0 : t.sampleRate) >= 0
            ? null == t
                ...
                : t.sampleRate
            : 1,
    Ah = gh("❌ Missing API Key. Set `apiKey` in HoneycombOptions. Telemetry will not be exported."),
    Ch = gh(`❌ Missing Service Name. Set \`serviceName\` in HoneycombOptions. Defaulting to '${fh.serviceName}'`),
    Ph =
        (gh("🔕 Dataset is ignored in favor of service name."),
        gh(
        ...
        gh("⏭️ Skipping options validation, because a custom collector is being used."),
        gh(
        ...
        gh("🔕 Disabling local visualizations - must have both service name and API key configured."),
        gh("🔕 Disabling local visualizations - cannot infer auth and ui url roots from endpoint url."),
        gh("🔕 Failed to get proper auth response from Honeycomb. No local visualization available."),
        gh("🔕 Default honeycomb exporter disabled but no exporters provided"),
        (t) => {
            var e, n;
            (null == t ? void 0 : t.logLevel) ? t.logLevel : pi.DEBUG;
            if (null == t ? void 0 : t.skipOptionsValidation) return void pi.DEBUG;
            const r =
            ...
            if (
                ...
                return (
                    !(null == t ? void 0 : t.apiKey) && pi.WARN,
                    !(null == t ? void 0 : t.serviceName) && pi.WARN,
                    (null == t ? void 0 : t.apiKey) &&
                        !bh(null == t ? void 0 : t.apiKey) &&
                    ...
                    (null == t ? void 0 : t.apiKey) &&
                        ...
                        !(null == t ? void 0 : t.dataset) &&
                        pi.WARN,
                    (null == t ? void 0 : t.sampler) && pi.DEBUG,
...
function Oh(t) {
    ...
    ks.setLogger(new Ci(), pi.DEBUG), ks.debug(gh("🐝 Honeycomb Web SDK Debug Mode Enabled 🐝"));
    const e = wh(t),
        n = Object.assign(Object.assign(Object.assign({}, fh), t), { tracesEndpoint: e });
    !(function (t) {
        const e = Eh(t) || "";
        if (!e) return void ks.debug(Ah);
        ks.debug(gh(`API Key configured for traces: '${e}'`));
    })(n),
        (function (t) {
            const e = t.serviceName || fh.serviceName;
            if (e === fh.serviceName) return void ks.debug(Ch);
            ks.debug(`@honeycombio/opentelemetry-web: Service Name configured for traces: '${e}'`);
        })(n),
        (function (t) {
            const e = wh(t);
            if (!e) return void ks.debug(gh("No endpoint configured for traces"));
            ks.debug(gh(`Endpoint configured for traces: '${e}'`));
        })(n),
        (function (t) {
            const e = Th(t);
            if (!e) return void ks.debug("No sampler configured for traces");
            ks.debug(gh(`Sample Rate configured for traces: '${e}'`));
        })(n);
}
const kh = (t) => {
...
class Lh {
    constructor(t) {
        switch (((this._sampleRate = t), t)) {
            case 0:
                this._sampler = new ta();
                break;
            case 1:
                this._sampler = new ea();
                break;
            default: {
                const e = 1 / t;
                this._sampler = new ra(e);
                break;
            }
        }
    }
...
const Rh = () => {
    ...
    Dh = (t) => {
        ...
        try {
            for (; 9 !== t?.nodeType; ) {
                const n = t,
                    r = n.id ? "#" + n.id : [Ih(n), ...Array.from(n.classList).sort()].join(".");
    ...
    Uh = new WeakMap();
function $h(t, e) {
    return Uh.get(t) || Uh.set(t, new e()), Uh.get(t);
}
let jh = -1;
const Bh = () => jh,
    Fh = (t) => {
        addEventListener(
            "pageshow",
            (e) => {
                e.persisted && ((jh = e.timeStamp), t(e));
            },
            !0
        );
    },
...
let Kh = -1;
const Xh = () => ("hidden" !== document.visibilityState || document.prerendering ? 1 / 0 : 0),
    Yh = (t) => {
        "hidden" === document.visibilityState &&
            Kh > -1 &&
            ((Kh = "visibilitychange" === t.type ? t.timeStamp : 0), Qh());
    },
    Jh = () => {
        addEventListener("visibilitychange", Yh, !0), addEventListener("prerenderingchange", Yh, !0);
    },
    Qh = () => {
        removeEventListener("visibilitychange", Yh, !0), removeEventListener("prerenderingchange", Yh, !0);
    },
    Zh = () => {
        if (Kh < 0) {
            const t = Vh(),
                ...
                for (const e of t)
                    "first-contentful-paint" === e.name &&
                        ...
                        e.startTime < n.firstHiddenTime &&
                            ((i.value = Math.max(e.startTime - Vh(), 0)), i.entries.push(e), r(!0)));
            });
            s &&
                ((r = Gh(t, i, ep, e.reportAllChanges)),
                Fh((n) => {
                    (i = Hh("FCP")),
                        (r = Gh(t, i, ep, e.reportAllChanges)),
                        zh(() => {
    ...
    rp = [0.1, 0.25],
    ip = (t) => t.find((t) => 1 === t.node?.nodeType) || t[0];
let sp = 0,
    op = 1 / 0,
    ap = 0;
const cp = (t) => {
    for (const e of t)
        e.interactionId &&
            ((op = Math.min(op, e.interactionId)),
            (ap = Math.max(ap, e.interactionId)),
            (sp = ap ? (ap - op) / 7 + 1 : 0));
};
let up;
const lp = () => (up ? sp : (performance.interactionCount ?? 0));
let dp = 0;
class hp {
    l = [];
    h = new Map();
    ...
    p;
    v() {
        (dp = lp()), (this.l.length = 0), this.h.clear();
    }
    M() {
        const t = Math.min(this.l.length - 1, Math.floor((lp() - dp) / 50));
        return this.l[t];
    }
    u(t) {
        ...
        if (n || this.l.length < 10 || t.duration > e.T) {
            if (
                (n
                    ...
                    : ((n = { id: t.interactionId, entries: [t], T: t.duration }), this.h.set(n.id, n), this.l.push(n)),
...
const pp = (t) => {
    ...
    mp = [200, 500],
    fp = (t, e = {}) => {
        const n = $h((e = Object.assign({}, e)), hp);
        let r = [],
            i = [],
            s = 0;
        const o = new WeakMap(),
        ...
        (n.m = (t) => {
            ...
            (n.p = (t) => {
                if (!a.get(t)) {
                    const n = (e.generateTarget ?? Dh)(t.entries[0].target);
                    a.set(t, n);
                }
            });
        const d = (t, e) => {
                ...
                globalThis.PerformanceEventTiming &&
                    ...
                    tp(() => {
                        "interactionCount" in performance ||
                            up ||
                            (up = Wh("event", cp, { type: "event", buffered: !0, durationThreshold: 0 }));
                        let n,
                            r = Hh("INP");
                        const i = $h(e, hp),
                            s = (t) => {
                            ...
                            o = Wh("event", s, { durationThreshold: e.durationThreshold ?? 40 });
                        (n = Gh(t, r, mp, e.reportAllChanges)),
                            o &&
                                ...
                                Fh(() => {
                                    i.v(), (r = Hh("INP")), (n = Gh(t, r, mp, e.reportAllChanges));
                                }));
                    });
            })((e) => {
                const r = ((t) => {
...
const _p = [2500, 4e3],
    ...
    bp = (t) => {
        document.prerendering
            ...
            : "complete" !== document.readyState
              ? addEventListener("load", () => bp(t), !0)
              : setTimeout(t);
    },
    yp = "browser.name",
    wp = "browser.version",
    Sp = "browser.touch_screen_enabled",
    xp = "browser.width",
    Ep = "browser.height",
    Tp = "device.type",
    Ap = "network.effectiveType",
    Cp = "screen.width",
    Pp = "screen.height",
    Op = "screen.size",
    kp = "page.hash",
    ...
    $p = "entry_page.search",
    jp = "entry_page.hash",
    Bp = "entry_page.hostname",
    Fp = "entry_page.referrer",
    Gp = "honeycomb.distro.version",
    zp = "honeycomb.distro.runtime_version",
    Vp = "cls.id",
    Hp = "cls.value",
    Wp = "cls.delta",
    qp = "cls.rating",
    Kp = "cls.navigation_type",
    Xp = "lcp.id",
    Yp = "lcp.value",
    Jp = "lcp.delta",
    Qp = "lcp.rating",
    Zp = "lcp.navigation_type",
    tm = "inp.id",
    em = "inp.value",
    nm = "inp.delta",
    rm = "inp.rating",
    im = "inp.navigation_type",
    sm = "fcp.id",
    om = "fcp.value",
    am = "fcp.delta",
    cm = "fcp.rating",
    um = "fcp.navigation_type",
    lm = "ttfb.id",
    dm = "ttfb.value",
    hm = "ttfb.delta",
    pm = "ttfb.rating",
    mm = "ttfb.navigation_type",
    fm = "cls.largest_shift_target",
    gm = "cls.element",
    _m = "cls.largest_shift_time",
    vm = "cls.largest_shift_value",
    bm = "cls.load_state",
    ym = "cls.had_recent_input",
    wm = "lcp.element",
    Sm = "lcp.url",
    xm = "lcp.time_to_first_byte",
    Em = "lcp.resource_load_delay",
    Tm = "lcp.resource_load_duration",
    Am = "lcp.element_render_delay",
    Cm = "lcp.resource_load_time",
    Pm = "inp.input_delay",
    Om = "inp.interaction_target",
    km = "inp.interaction_time",
    Lm = "inp.interaction_type",
    Mm = "inp.load_state",
    Rm = "inp.next_paint_time",
    Nm = "inp.presentation_delay",
    Im = "inp.processing_duration",
    Dm = "inp.duration",
    Um = "inp.element",
    $m = "inp.event_type",
    jm = "inp.timing.script.entry_type",
    Bm = "inp.timing.script.start_time",
    Fm = "inp.timing.script.execution_start",
    Gm = "inp.timing.script.duration",
    zm = "inp.timing.script.forced_style_and_layout_duration",
    Vm = "inp.timing.script.invoker",
    Hm = "inp.timing.script.pause_duration",
    Wm = "inp.timing.script.source_url",
    qm = "inp.timing.script.source_function_name",
    Km = "inp.timing.script.source_char_position",
    Xm = "inp.timing.script.window_attribution",
    Ym = "inp.timing.duration",
    Jm = "inp.timing.entryType",
    Qm = "inp.timing.name",
    Zm = "inp.timing.renderStart",
    tf = "inp.timing.startTime",
    ef = "fcp.time_to_first_byte",
    nf = "fcp.time_since_first_byte",
    rf = "fcp.load_state",
    sf = "ttfb.waiting_duration",
    of = "ttfb.dns_duration",
    af = "ttfb.connection_duration",
    cf = "ttfb.request_duration",
    uf = "ttfb.cache_duration",
    lf = "ttfb.waiting_time",
    df = "ttfb.dns_time",
    hf = "ttfb.connection_time",
    pf = "ttfb.request_time";
class mf {
    constructor(t, e, n = {}) {
        (this.instrumentationName = t),
            (this.instrumentationVersion = e),
            (this._wrap = Mc.wrap),
            (this._unwrap = Mc.unwrap),
            (this._massWrap = Mc.massWrap),
            (this._massUnwrap = Mc.massUnwrap),
            (this._config = Object.assign({ enabled: !0 }, n)),
            (this._diag = ks.createComponentLogger({ namespace: t })),
            (this._tracer = Vs.getTracer(t, e)),
            (this._meter = Rs.getMeter(t, e)),
...
class ff extends mf {
    constructor({
        ...
        super("@honeycombio/instrumentation-web-vitals", Pc, {
            enabled: t,
            vitalsToTrack: e,
            lcp: n,
            cls: r,
            ...
            (this.onReportCLS = (t, e = {}) => {
                ...
                l.setAttributes({
                    ...
                    [vm]: a,
                    [bm]: c,
                    [ym]: null == u ? void 0 : u.hadRecentInput,
                }),
                    n && n(t, l),
                    l.end();
            }),
    ...
    _setupWebVitalsCallbacks() {
        this.vitalsToTrack.includes("CLS") &&
            ((t, e = {}) => {
                const n = $h((e = Object.assign({}, e)), Mh),
                    r = new WeakMap();
                (n.t = (t) => {
                    if (t?.sources?.length) {
                        const n = ip(t.sources);
                        if (n) {
                            const t = (e.generateTarget ?? Dh)(n.node);
                            r.set(n, t);
                        }
                    }
                }),
                        ...
                        np(
                            qh(() => {
                                ...
                                const i = $h(e, Mh),
                                    ...
                                    o = Wh("layout-shift", s);
                                o &&
                                    ((n = Gh(t, r, rp, e.reportAllChanges)),
                                    document.addEventListener("visibilitychange", () => {
                                        "hidden" === document.visibilityState && (s(o.takeRecords()), n(!0));
                                    }),
                                    Fh(() => {
            ...
            this.vitalsToTrack.includes("LCP") &&
                ((t, e = {}) => {
                    const n = $h((e = Object.assign({}, e)), gp),
                        r = new WeakMap();
                    (n.m = (t) => {
                        if (t.element) {
                            const n = (e.generateTarget ?? Dh)(t.element);
                            r.set(t, n);
                        }
                    }),
                        ((t, e = {}) => {
                                ...
                                const s = $h(e, gp),
                                    o = (t) => {
                                        ...
                                        for (const e of t)
                                            s.u(e),
                                                e.startTime < n.firstHiddenTime &&
                                                    ((i.value = Math.max(e.startTime - Vh(), 0)),
                                                    (i.entries = [e]),
                                                    r());
                                    },
                                    a = Wh("largest-contentful-paint", o);
                                if (a) {
                                    r = Gh(t, i, _p, e.reportAllChanges);
                                    const n = qh(() => {
                                        o(a.takeRecords()), a.disconnect(), r(!0);
                                    });
                                    for (const t of ["keydown", "click", "visibilitychange"])
                                        addEventListener(t, () => pp(n), { capture: !0, once: !0 });
                                    Fh((n) => {
                                        (i = Hh("LCP")),
                                            (r = Gh(t, i, _p, e.reportAllChanges)),
                                            zh(() => {
            ...
            this.vitalsToTrack.includes("TTFB") &&
                ((t, e = {}) => {
                    ((t, e = {}) => {
                        let n = Hh("TTFB"),
                            r = Gh(t, n, vp, e.reportAllChanges);
                        bp(() => {
                            const i = Rh();
                            i &&
                                ((n.value = Math.max(i.responseStart - Vh(), 0)),
                                (n.entries = [i]),
                                r(!0),
                                Fh(() => {
                                    (n = Hh("TTFB", 0)), (r = Gh(t, n, vp, e.reportAllChanges)), r(!0);
                                }));
                        });
                    })((e) => {
                        const n = ((t) => {
            ...
            this.vitalsToTrack.includes("FCP") &&
                ((t, e = {}) => {
                    np((e) => {
                        const n = ((t) => {
                            let e = { timeToFirstByte: 0, firstByteToFCP: t.value, loadState: Nh(Bh()) };
                            if (t.entries.length) {
                                const n = Rh(),
                                    r = t.entries.at(-1);
                                if (n) {
                                    ...
                                    e = {
                                        ...
                                        loadState: Nh(t.entries[0].startTime),
                                        navigationEntry: n,
                                        fcpEntry: r,
                                    };
                                }
    ...
    getAttributesForPerformanceLongAnimationFrameTiming(t) {
        return { [Ym]: t.duration, [Jm]: t.entryType, [Qm]: t.name, [Zm]: t.renderStart, [tf]: t.startTime };
    }
    getAttributesForPerformanceScriptTiming(t) {
        return {
            ...
            [Fm]: t.executionStart,
            [Gm]: t.duration,
            [zm]: t.forcedStyleAndLayoutDuration,
            [Vm]: t.invoker,
            [Hm]: t.pauseDuration,
            [Wm]: t.sourceURL,
            [qm]: t.sourceFunctionName,
            [Km]: t.sourceCharPosition,
            [Xm]: t.windowAttribution,
        };
    }
    processPerformanceLongAnimationFrameTimingSpans(t, e) {
        ...
        this.tracer.startActiveSpan(e.name, { startTime: e.startTime }, (r) => {
            r.setAttributes(n), this.processPerformanceScriptTimingSpans(t, e.scripts), r.end(e.startTime + e.duration);
        });
    }
    ...
    addDataAttributes(t, e, n, r) {
        ...
        if (null == i ? void 0 : i.dataset)
            for (const s in i.dataset) {
                const t = i.dataset[s];
                void 0 === t || (void 0 !== n && !n.includes(s)) || e.setAttribute(`${r}.element.data.${s}`, t);
            }
    }
    disable() {
        this.isEnabled()
...
const gf = "@honeycombio/instrumentation-global-errors";
function _f(t, e = {}, n = Vs.getTracer(gf), r) {
    const i = t.message,
        s = t.name,
        o = Object.assign(
            Object.assign(
                { [Ua]: s, [Ia]: i, [Da]: t.stack },
                (function (t) {
                    if (!t) return {};
                    const e = Dc.computeStackTrace(t).stack,
                        n = [],
                        r = [],
                        i = [],
                        s = [];
        ...
        a = n.startSpan("exception", { attributes: o }, Os.active());
    r && r(a, t), a.setStatus({ code: xs.ERROR, message: i }), a.end();
}
class vf extends mf {
    constructor({ enabled: t = !0, applyCustomAttributesOnSpan: e } = {}) {
        super(gf, Pc, { enabled: t, applyCustomAttributesOnSpan: e }),
            (this.onError = (t) => {
                const e = "reason" in t ? t.reason : t.error;
                e && _f(e, {}, this.tracer, this.applyCustomAttributesOnSpan);
            }),
            t && this.enable(),
            (this._isEnabled = t),
...
const bf = "x-honeycomb-team",
    yf = "x-honeycomb-dataset";
function wf(t, e, n, r = !1) {
    const i = Object.assign(Object.assign({}, null == t ? void 0 : t.headers), n);
    return (
        e && !i[bf] && (i[bf] = e),
        bh(e) &&
            (r && (null == t ? void 0 : t.metricsDataset)
                ? (i[yf] = null == t ? void 0 : t.metricsDataset)
                : (null == t ? void 0 : t.dataset) && (i[yf] = null == t ? void 0 : t.dataset)),
        i
    );
}
const Sf = (t = "") => {
    ...
    return { authRoot: `${e.protocol}//${r}.honeycomb.io/1/auth`, uiRoot: `${e.protocol}//${i}.honeycomb.io` };
};
class xf {
    constructor(t, e, n, r, i) {
        if (((this._traceUrl = ""), (this._logLevel = pi.DEBUG), n && (this._logLevel = n), !t || !e))
            return this._logLevel, void pi.DEBUG;
        if (!r || !i) return this._logLevel, void pi.DEBUG;
    ...
    export(t, e) {
        this._traceUrl &&
            t.forEach((t) => {
                var e;
                !(null === (e = t.parentSpanContext) || void 0 === e ? void 0 : e.spanId) && (this._logLevel, pi.INFO);
            }),
            e({ code: oc.SUCCESS });
    }
    shutdown() {
    ...
    return (
        (null == t ? void 0 : t.localVisualizations) &&
            e.push(
                (function (t) {
                    const e = Eh(t),
                        { authRoot: n, uiRoot: r } = Sf((null == t ? void 0 : t.tracesEndpoint) || wh(t));
                    return new xf(null == t ? void 0 : t.serviceName, e, null == t ? void 0 : t.logLevel, n, r);
                })(t)
            ),
        ...
        !0 !== (null == t ? void 0 : t.disableDefaultTraceExporter) &&
            e.unshift(
                (function (t) {
                    ...
                    return new Bu({
                        url: wh(t),
                        headers: wf(t, e, null == t ? void 0 : t.tracesHeaders),
                        timeoutMillis:
...
function Tf(t) {
    ...
    return (
        ...
        !0 !== (null == t ? void 0 : t.disableDefaultMetricExporter) &&
            e.unshift(
                (function (t) {
                    const e = ((t) => (null == t ? void 0 : t.metricsApiKey) || (null == t ? void 0 : t.apiKey))(t);
                    return new Xu({
                        url: Sh(t),
                        headers: wf(t, e, null == t ? void 0 : t.metricsHeaders, !0),
                        timeoutMillis:
                            (null == t ? void 0 : t.metricsTimeout) || (null == t ? void 0 : t.timeout) || 1e4,
                    });
                })(t)
            ),
        (null == t ? void 0 : t.localVisualizations) && e.push(new td()),
        e
    );
}
function Af(t) {
    ...
    return (
        e.push(
            (function (t) {
                const e = ((t) => (null == t ? void 0 : t.logsApiKey) || (null == t ? void 0 : t.apiKey))(t);
                return new Yu({
                    url: xh(t),
                    headers: wf(t, e, null == t ? void 0 : t.logsHeaders),
                    timeoutMillis: (null == t ? void 0 : t.logsTimeout) || (null == t ? void 0 : t.timeout) || 1e4,
                });
            })(t)
        ),
        (null == t ? void 0 : t.localVisualizations) && e.push(new sh()),
        e
    );
}
class Cf {
    ...
    export(t, e) {
        this._exporters.forEach((n) => n.export(t, e)), e({ code: oc.SUCCESS });
    }
    async shutdown() {
        const t = [];
...
class Pf {
    ...
    onStart(t, e) {
        var n, r;
        (null !== (r = null === (n = Gs.getBaggage(e)) || void 0 === n ? void 0 : n.getAllEntries()) && void 0 !== r
            ? r
            : []
        ).forEach((e) => {
            t.setAttribute(e[0], e[1].value),
                ks.debug(`@honeycombio/opentelemetry-web: 🚨 Baggage in all outgoing headers: ${e[0]}=${e[1].value} `);
        });
    }
    onEnd() {}
    forceFlush() {
...
const kf = new la().generateTraceId(),
    Lf = { getSessionId: () => kf },
    Mf = (t) => {
        const e = [];
        var n;
        return (
            (null == t ? void 0 : t.disableBrowserAttributes) || e.push(new Of()),
            e.push(
                new Pf(),
                ((n = (null == t ? void 0 : t.sessionProvider) || Lf), new Ju(n)),
    ...
    Rf = "browser.language",
    Nf = "browser.mobile",
    If = "telemetry.distro.name",
    Df = "telemetry.distro.version";
const Uf = { path: !0, hash: !0, hostname: !0, referrer: !0, url: !1, search: !1 };
function $f(t) {
    if (!1 === t || !(null === window || void 0 === window ? void 0 : window.location)) return co({});
    const e = (function (t) {
            if (!t) return Uf;
            return Object.assign(Object.assign({}, Uf), t);
        })(t),
    ...
    return co({
        ...
        [jp]: jf(e.hash, s),
        [Bp]: jf(e.hostname, o),
        [Fp]: jf(e.referrer, document.referrer),
    });
}
function jf(t, e) {
    if (t) return e;
...
function Bf() {
    ...
    return co({
        ...
        [Nf]: navigator.userAgent.includes("Mobi"),
        [Sp]: navigator.maxTouchPoints > 0,
        [Rf]: navigator.language,
        [yp]: t,
        [wp]: e,
        [Tp]: n,
        [Ap]:
        ...
        [Cp]: window.screen.width,
        [Pp]: window.screen.height,
        [Op]:
...
const Ff = (t) => {
    ...
    return (
        (null == t ? void 0 : t.disableBrowserAttributes) ||
            (e = e.merge($f(null == t ? void 0 : t.entryPageAttributes)).merge(Bf())),
        (e = e.merge(co({ [Gp]: Pc, [zp]: "browser", [If]: "@honeycombio/opentelemetry-web", [Df]: Pc }))),
        (null == t ? void 0 : t.resource) && (e = e.merge(t.resource)),
        (null == t ? void 0 : t.resourceAttributes) && (e = e.merge(co(t.resourceAttributes))),
        e
    );
};
class Gf extends ah {
    constructor(t) {
        ...
        !1 !==
            (null === (e = null == t ? void 0 : t.webVitalsInstrumentationConfig) || void 0 === e
                ? void 0
                : e.enabled) && r.push(new ff(null == t ? void 0 : t.webVitalsInstrumentationConfig)),
            !1 !==
                (null === (n = null == t ? void 0 : t.globalErrorsInstrumentationConfig) || void 0 === n
                    ? void 0
                    : n.enabled) && r.push(new vf(null == t ? void 0 : t.globalErrorsInstrumentationConfig)),
            super(
                Object.assign(Object.assign({}, t), {
                    ...
                    spanProcessors: Mf(t),
                    traceExporter: Ef(t),
                    metricExporters: Tf(t),
                    logExporters: Af(t),
                })
            ),
            Ph(t),
            (null == t ? void 0 : t.debug) && Oh(t);
    }
}
const zf = "claude-browser-extension";
async function Vf(t, e, n) {
    return Vs.getTracer(zf).startActiveSpan(
        t,
        { kind: ws.INTERNAL },
        n ? Vs.setSpan(Os.active(), n) : Os.active(),
        async (t) => {
            try {
                const n = await e(t);
                return t.setStatus({ code: xs.OK }), n;
            } catch (n) {
                throw (t.setStatus({ code: xs.ERROR, message: n.message }), t.recordException(n), n);
            } finally {
                t.end();
            }
        }
...
class qf {
    ...
    async checkPermission(t, e) {
        if (this.bypassLocalhostForMcp && this.isLocalhostUrl(t)) return { allowed: !0, needsPrompt: !1 };
    ...
    async checkDomainTransition(t, e) {
        ...
        const n = this.permissions.filter(
                (n) => "domain_transition" === n.scope.type && n.scope.fromDomain === t && n.scope.toDomain === e
            ),
            i = n.find((t) => t.action === r.DENY);
        if (i) return (i.lastUsed = Date.now()), await this.savePermissions(), { allowed: !1, permission: i };
    ...
    async denyPermission(t, e) {
        if (e === i.ONCE) return;
        const n = { id: crypto.randomUUID(), scope: t, action: r.DENY, duration: e, createdAt: Date.now() };
...
export { qf as P, xs as S, Wf as a, Hf as g, ni as i, Vf as w };
