...
import { u as t, M as o } from "./index-CiXNXYRN.js";
function r({ requestId: r, clientType: a, currentName: l, onConfirm: n, onDismiss: d }) {
    const c = t(),
        [i, x] = e.useState(l || ""),
        u = e.useRef(null);
    e.useEffect(() => {
    ...
    const b = e.useCallback(() => {
        ...
        g = "claude-code" === a ? "Claude Code" : "Claude Desktop";
    return s.jsxs("div", {
            ...
            s.jsxs("div", {
                ...
                children: [
                    s.jsx("button", {
                        ...
                        children: s.jsx(o, { defaultMessage: "Ignore", id: "paBpxNk4t8" }),
                    }),
                    s.jsx("button", {
                        onClick: b,
                        disabled: !i.trim(),
                        ...
                        children: s.jsx(o, { defaultMessage: "Connect", id: "+vVZ/G11Zg" }),
                    }),
                ],
            }),
        ],
