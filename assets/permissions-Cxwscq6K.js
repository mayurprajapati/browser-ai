...
const qt = async () => {
    ...
    Ht = async () => {
        // Claude OAuth sign-in disabled: this build authenticates with the
        // provider API key from provider-registry, not an Anthropic account.
        console.info("[Browser AI] Claude OAuth sign-in is disabled in this build.");
    },
    Yt = Object.freeze(
