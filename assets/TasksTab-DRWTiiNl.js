...
import { u as w, M as b } from "./index-CiXNXYRN.js";
import { a as C, g as k, S as M, r as j } from "./permissions-Cxwscq6K.js";
const A = new Map([
        [
            "bold",
            e.createElement(
...
function Z({ toast: a, onClose: o }) {
    ...
    return t.jsxs("div", {
        className: s(
            ...
            r ? ["opacity-0 translate-x-full"] : ["animate-toast-slide-in", "opacity-100 translate-x-0"]
        ),
        style: { animation: r ? void 0 : "toast-slide-in 0.3s ease-out" },
        children: [
            "success" === a.type && t.jsx(n, { size: 16, className: "text-accent-100 flex-shrink-0" }),
...
function F({
        ...
        [y, x] = e.useState(
            (() => {
                ...
                const e = window.location.hash,
                    t = e.indexOf("?");
                if (-1 !== t) {
                    return "browse" === new URLSearchParams(e.substring(t)).get("tab") ? "browse" : "my-shortcuts";
                }
                return "my-shortcuts";
            })()
        ),
    ...
    e.useEffect(() => {
        Z();
        (async () => {
            const e = await k(M.PENDING_SCHEDULED_TASK);
            if (e) {
                ...
                A({
                    ...
                    D(!0),
                    await j(M.PENDING_SCHEDULED_TASK);
            }
        })();
    }, [A, D]);
    const V = async (e) => {
        confirm(
            d.formatMessage({ defaultMessage: "Are you sure you want to delete this prompt?", id: "eJFbw2HgHp" })
        ) &&
            (await C.deletePrompt(e),
            v?.id === e && (A(null), D(!1)),
            Z(),
            N(d.formatMessage({ defaultMessage: "Shortcut deleted", id: "RRFjL3H23m" })));
    };
                                ...
                                t.jsxs("div", {
                                    ...
                                    children: [
                                        ...
                                        t.jsx(o, {
                                            ...
                                            size: "sm",
                                            className: "ml-2",
                                            children: t.jsx(b, { defaultMessage: "Create shortcut", id: "AzO4h7b149" }),
                                        }),
                                    ],
                                }),
                            l &&
                        ...
                        children: t.jsxs(l, {
                            ...
                            children: [
                                t.jsx(c, {
                                    ...
                                    children: t.jsx(b, { defaultMessage: "Edit", id: "wEQDC6Wv3/" }),
                                }),
                                t.jsx(c, {
                                    ...
                                    children: t.jsx(b, { defaultMessage: "Delete", id: "K3r6DQW7h+" }),
                                }),
                            ],
                        }),
                    }),
...
function _({ prompt: a, onClose: s, onSave: n }) {
    const i = w(),
        ...
        [H, Z] = e.useState(a?.repeatType && "none" !== a.repeatType ? a.repeatType : "once"),
        [T, L] = e.useState(a?.specificTime || "09:00"),
        [F, O] = e.useState(a?.dayOfWeek ?? 0),
        [_, I] = e.useState(a?.dayOfMonth || 1),
        [z, V] = e.useState((a?.monthAndDay && parseInt(a.monthAndDay.split("-")[0])) || 1),
        [B, W] = e.useState((a?.monthAndDay && parseInt(a.monthAndDay.split("-")[1])) || 1),
        [R, $] = e.useState(a?.specificDate || ""),
        [P, U] = e.useState(a?.url || ""),
        G = p(),
        [Y, q] = e.useState(a?.model || G.default || "claude-sonnet-4-5-20250929");
    e.useEffect(() => {
        setTimeout(() => {
            D.current?.focus();
        }, 100),
        ...
        e.useEffect(() => {
            const e = (e) => {
                if ("Enter" === e.key) {
                    ...
                    "INPUT" === t?.tagName || "TEXTAREA" === t?.tagName || (e.preventDefault(), J());
                }
            };
            return document.addEventListener("keydown", e), () => document.removeEventListener("keydown", e);
        }, [r, c]);
    const J = async () => {
        if ((A(!0), M(""), r.trim() && c.trim())) {
            if (E && P.trim()) {
                const e = P.trim();
                if (!e.startsWith("http://") && !e.startsWith("https://"))
                    return void M(
                        i.formatMessage({ defaultMessage: "URL must start with http:// or https://", id: "PMPIVxGCgO" })
                    );
                try {
                    new URL(e);
                } catch {
                    return void M(i.formatMessage({ defaultMessage: "Invalid URL format", id: "Zx2+7F8Kf5" }));
                }
            }
            try {
                if (a && !S) {
    ...
    return t.jsxs(u, {
        ...
        title:
            a && !S
                ...
                : i.formatMessage({ defaultMessage: "Create shortcut", id: "AzO4h7b149" }),
        modalSize: "lg",
        hasCloseButton: !0,
                ...
                children: [
                    t.jsxs("div", {
                        children: [
                            t.jsx("span", {
                                ...
                                children: t.jsx(b, { defaultMessage: "Name", id: "HAlOn1ZsuY" }),
                            }),
                            t.jsx(f, {
                                ref: D,
                                type: "text",
                                ...
                                placeholder: i.formatMessage({ defaultMessage: "task-name", id: "zfW5u5DbnY" }),
                            ...
                            ((j && !r.trim()) || m?.includes("already in use")) &&
                                t.jsx(g, {
                                    ...
                                    children:
                                        j && !r.trim()
                                            ? t.jsx(b, { defaultMessage: "Name is required", id: "Gvxoji2HqE" })
                                            : m,
                                }),
                        ],
                    }),
                    t.jsxs("div", {
                        children: [
                            t.jsx("span", {
                                className: "font-base text-text-200 block mb-1",
                                children: t.jsx(b, { defaultMessage: "Prompt", id: "iWKE8shLIt" }),
                            }),
                            t.jsx(y, {
                                required: !0,
                                value: c,
                                ...
                                error:
                                    j && !c.trim()
                                        ? i.formatMessage({ defaultMessage: "Prompt is required", id: "E8uSl+czLg" })
                                        : void 0,
                            }),
                        ],
                    }),
                    ...
                    t.jsx(o, {
                        ...
                        children:
                            a && !S
                                ...
                                : t.jsx(b, { defaultMessage: "Create shortcut", id: "AzO4h7b149" }),
                    }),
                ],
            }),
        ],
